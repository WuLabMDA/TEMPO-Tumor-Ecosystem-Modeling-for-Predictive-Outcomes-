% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_Sobs_NT053.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_p053';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p053';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[1.3082e+00 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 2.0586e+00...   % CC parameters
                 4.7101e+00 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 8.4202e+00...   % Treg parameters
                 9.8581e+00 45 0.330 0.411 0.228 0.113 9.2016e+00... % Teff parameters
                 1.1105e-01 10 0.60 0.898 0.7 0.112 0.120 9.3231e+00...   % M parameters
                 6.0728e+00 10 7.7018e+00...      % EC parameters
                 9.7685e+00 65 0.7696 0.064 2.2166e-01]; % F parameters % These values may be updated during optimization  


% 0.178 0.138 9.4882e+00 0.105 0.109 0.104 0.108 
% 
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[43.85 3.35 5.13 2.56 3.45 29.83];  %Initial conditions for each experiment          
