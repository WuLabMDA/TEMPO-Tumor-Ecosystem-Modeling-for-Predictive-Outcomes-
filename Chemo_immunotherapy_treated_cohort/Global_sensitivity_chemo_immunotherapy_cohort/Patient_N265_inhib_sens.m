...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_p265_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p265_inhib';                      % To identify figures and reports for a given problem   
