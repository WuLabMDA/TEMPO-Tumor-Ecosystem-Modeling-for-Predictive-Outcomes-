...
Patient_N179_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N179_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N179 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
