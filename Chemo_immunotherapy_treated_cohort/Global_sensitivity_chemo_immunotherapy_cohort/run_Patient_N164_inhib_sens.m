...
Patient_N164_inhib_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N164_PCR_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N164 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
