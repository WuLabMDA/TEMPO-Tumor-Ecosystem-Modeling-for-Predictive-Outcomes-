...
Patient_N279_inhib_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N279_RD_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N279 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
