...
Patient_N255_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N255_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N255 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
