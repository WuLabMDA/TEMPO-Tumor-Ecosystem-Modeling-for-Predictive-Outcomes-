...
Patient_N223_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
parameter_names = {'Gr\_cc', 'Gr\_treg','Gr\_teff','Gr\_m', 'Gr\_ec', 'Gr\_f' };
...
output_filename = 'Patient_N223_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N223 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
