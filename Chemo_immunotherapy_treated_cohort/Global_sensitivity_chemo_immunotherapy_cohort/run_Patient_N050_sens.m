...
Patient_N050_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N050_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N050 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
