...
Patient_N060_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N060_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N060 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
