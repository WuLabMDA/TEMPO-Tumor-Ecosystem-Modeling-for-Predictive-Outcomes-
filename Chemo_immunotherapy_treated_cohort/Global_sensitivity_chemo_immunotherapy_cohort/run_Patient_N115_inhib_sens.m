...
Patient_N115_inhib_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
parameter_names = {'In\_cc', 'In\_treg','In\_teff','In\_m', 'In\_ec', 'In\_f' };
...
output_filename = 'Patient_N115_PCR_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N115 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
