...
Patient_N101_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N101_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N101 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
