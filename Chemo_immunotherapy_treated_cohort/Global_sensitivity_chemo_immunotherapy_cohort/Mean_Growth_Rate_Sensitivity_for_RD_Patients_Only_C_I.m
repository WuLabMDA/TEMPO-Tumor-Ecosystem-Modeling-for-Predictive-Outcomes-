...
filePattern = fullfile(pwd, '*RD*Growth_Rate_Sensitivity_Matrix.csv');
...
if isempty(allSensitivityMatrices)
    error('No RD Growth Rate Sensitivity Matrix CSV files found in the current directory.');
end
...
title('Chemo\_&\_Immunotherapy RD Patients Mean G\_R Sensitivity Matrix');
colormap('parula');
