% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_Sobs_NT275.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_73';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p73';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.9096e+00 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 8.5294e-01...   % CC parameters
                 7.9270e+00 10 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 6.3272e+00...   % Treg parameters
                 5.8200e-01 65 0.300 0.421 0.128 0.113 7.8624e+00... % Teff parameters
                 2.9293e+00 30 0.30 0.298 0.1 0.112 0.120 9.9096e+00...   % M parameters
                 9.9096e+00 15 5.8178e-01...      % EC parameters
                 8.7780e+00 60 0.1996 0.064 5.8171e-01]; % F parameters % These values may be updated during optimization  


% 
% 0.118 0.108 8.2593e-01 0.105 0.109 0.104 0.101 
%==================================
% EXPERIMENTAL SCHEME RELATED DATA
%==================================
 inputs.exps.n_exp=1;                                  %Number of experiments                                                                            
 for iexp=1:inputs.exps.n_exp   
 inputs.exps.exp_y0{iexp}=[45.70 4.41 13.09 10.20 7.01 19.60];  %Initial conditions for each experiment          
