% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_Sobs_NT050.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_p050';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p050';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[2.4242e-01 10 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 9.9696e+00...   % CC parameters
                 9.4553e+00 15 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 8.3352e+00...   % Treg parameters
                 1.3385e-01 65 0.130 0.111 0.028 0.113 5.3656e+00... % Teff parameters
                 6.8871e+00 35 0.60 0.898 0.7 0.112 0.120 9.0904e+00...   % M parameters
                 6.4863e+00 10 5.8506e-01...      % EC parameters
                 7.9520e+00 65 0.1696 0.064 1.5431e+00]; % F parameters % These values may be updated during optimization  


% 0.178 0.138 8.1995e+00 0.105 0.109 0.104 0.0138
% 
% 
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[6.54 8.49 54.38 16.33 4.18 10.08];  %Initial conditions for each experiment          
