...
filePattern = fullfile(pwd, '*PCR*Growth_Rate_Sensitivity_Matrix.csv');
...
if isempty(allSensitivityMatrices)
    error('No PCR Growth Rate Sensitivity Matrix CSV files found in the current directory.');
end
...
columnLabels = {'Gr\_cc',  'Gr\_treg', 'Gr\_teff', 'Gr\_m', 'Gr\_ec', 'Gr\_f'};
...
title('Chemo\_&\_Immunotherapy PCR Patients Mean G\_R Sensitivity Matrix');
colormap('parula');
