% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_Sobs_NT122.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_p122';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p122';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[1.7746e+00 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 3.3380e+00...   % CC parameters
                 3.6052e+00 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 4.6404e+00...   % Treg parameters
                 8.0301e+00 25 0.430 0.311 0.128 0.113 4.8007e+00... % Teff parameters
                 8.5673e-01 10 0.20 0.298 0.1 0.112 0.120 8.9101e-01...   % M parameters
                 9.9645e+00 10 2.2462e-01...      % EC parameters
                 6.6732e+00 25 0.2696 0.064 7.8757e-02]; % F parameters % These values may be updated during optimization  


% 0.118 0.138 5.0481e+00 0.105 0.109 0.104 0.0101
% 
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[76.69 1.48 3.83 1.82 5.65 11.63];  %Initial conditions for each experiment          
