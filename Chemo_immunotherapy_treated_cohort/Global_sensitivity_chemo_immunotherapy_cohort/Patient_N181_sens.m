% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_Sobs_NT181.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_immuno_p181';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_immuno_p181';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[3.3778e-01 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 9.2776e+00...   % CC parameters
                 2.5532e+00 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 2.8710e+00...   % Treg parameters
                 6.6614e+00 40 0.300 0.421 0.128 0.113 4.4783e+00... % Teff parameters
                 1.8950e+00 10 0.30 0.298 0.1 0.112 0.120 8.3544e+00...   % M parameters
                 4.5143e+00 10 4.4708e+00...      % EC parameters
                 5.3650e+00 65 0.1996 0.064 1.4528e-01]; % F parameters % These values may be updated during optimization  


% 0.118 0.108 4.8985e+00 0.105 0.109 0.104 0.101
% 
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[43.13 8.13 8.86 6.57 3.60 29.56];  %Initial conditions for each experiment          
