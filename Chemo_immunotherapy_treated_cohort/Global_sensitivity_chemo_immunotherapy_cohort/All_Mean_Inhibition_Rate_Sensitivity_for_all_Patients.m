...
filePattern = fullfile(pwd, '*Inhibition_Rate_Sensitivity_Matrix.csv');
...
if isempty(allSensitivityMatrices)
    error('No Inhibition Rate Sensitivity Matrix CSV files found in the current directory.');
end
...
title('Chemo\_&\_Immunotherapy All Patients Mean I\_R Sensitivity Matrix');
colormap('parula');
