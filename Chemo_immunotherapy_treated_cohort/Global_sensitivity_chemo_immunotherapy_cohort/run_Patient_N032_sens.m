...
Patient_N032_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N032_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N032 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
