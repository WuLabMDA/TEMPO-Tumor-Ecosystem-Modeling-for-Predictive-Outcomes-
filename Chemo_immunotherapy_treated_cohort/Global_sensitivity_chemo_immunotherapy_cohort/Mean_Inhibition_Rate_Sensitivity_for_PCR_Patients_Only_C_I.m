...
filePattern = fullfile(pwd, '*PCR*Inhibition_Rate_Sensitivity_Matrix.csv');
...
if isempty(allSensitivityMatrices)
    error('No PCR Inhibition Rate Sensitivity Matrix CSV files found in the current directory.');
end
...
columnLabels = {'mu\_cc',  'mu\_treg', 'mu\_teff', 'mu\_m', 'mu\_ec', 'mu\_f'};
...
title('Chemo\_&\_Immunotherapy PCR Patients Mean I\_R Sensitivity Matrix');
colormap('parula');
