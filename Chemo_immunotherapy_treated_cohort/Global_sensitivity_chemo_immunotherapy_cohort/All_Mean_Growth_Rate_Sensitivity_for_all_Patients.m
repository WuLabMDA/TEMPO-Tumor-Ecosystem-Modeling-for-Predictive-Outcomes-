...
filePattern = fullfile(pwd, '*Growth_Rate_Sensitivity_Matrix.csv');
...
if isempty(allSensitivityMatrices)
    error('No All Growth Rate Sensitivity Matrix CSV files found in the current directory.');
end
...
title('Chemo\_&\_Immunotherapy All Patients Mean G\_R Sensitivity Matrix');
colormap('parula');
