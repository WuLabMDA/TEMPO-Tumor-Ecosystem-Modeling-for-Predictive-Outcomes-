...
Patient_N017_sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N017_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N017 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
