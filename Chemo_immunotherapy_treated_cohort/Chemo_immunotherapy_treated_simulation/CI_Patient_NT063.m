% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT063.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_17';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p17';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 40 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 ...
                 9.015 20 0.430 0.411 0.228 0.467 0.113  0.105 0.0018... % Teff parameters
                 8.10 25 0.60 0.898 0.7 0.112 0.120 0.109 0.0025...   % M parameters
                 0.091 10 0.144 0.195...      % EC parameters
                 9.185 75 0.696 0.064 0.108 0.001]; % F parameters % These values may be updated during optimization  


% 0.0115 0.235 0.015 0.205 9.015 0.467 0.0018 8.10 0.0025 0.091 0.195 9.185 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		73.63 2.57 4.45 2.00 2.65 19.26
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.06 0.51 29.35 37.48 0.60 36.66 
		];
...
inputs.PEsol.global_theta_guess=[0.0115 0.235 0.015 0.205 9.015 0.467 0.0018 8.10 0.0025 0.091 0.195 9.185 0.001];
