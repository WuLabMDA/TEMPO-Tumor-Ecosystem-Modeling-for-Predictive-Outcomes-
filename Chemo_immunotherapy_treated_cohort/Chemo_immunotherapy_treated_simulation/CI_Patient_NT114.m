% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT114.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_27';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p27';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		38.38 6.16 13.56 7.67 3.95 30.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       59.93 4.31 7.32 5.32 2.66 15.92 
		];
