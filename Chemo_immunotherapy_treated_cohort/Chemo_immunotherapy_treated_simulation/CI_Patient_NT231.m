% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT231.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_60';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p60';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		82.07 4.09 2.56 1.40 2.69 9.33
        %18.39 6.84 16.77 15.87 2.71 39.42 
       4.91 0.506 30.48 7.56 0.95 54.34 
		];
