% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT275.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_73';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p73';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 8.015 10 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.005...   % Treg parameters
                 8.095 65 0.300 0.421 0.128 0.467 0.113  0.105 0.001... % Teff parameters
                 9.510 30 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
                 8.0431 15 0.104 0.021...      % EC parameters
                 9.485 60 0.1996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.015 0.215 8.015 0.005 8.095 0.467 0.001 9.510 0.02 8.0431 0.021 0.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		45.70 4.41 13.09 10.20 7.01 19.60
        %18.39 6.84 16.77 15.87 2.71 39.42 
       89.84 4.001 2.21 1.053 0.502 1.24 
		];
...
inputs.PEsol.global_theta_guess=[0.015 0.215 8.015 0.005 8.095 0.467 0.001 9.510 0.02 8.0431 0.021 0.485 0.001];
