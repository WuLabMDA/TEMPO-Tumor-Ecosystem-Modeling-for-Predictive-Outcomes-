% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT143.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_32';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p32';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[4.015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.05...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 0.015 25 0.030 0.111 0.128 0.167 0.113  0.105 0.184... % Teff parameters
                 0.010 10 0.20 0.298 0.1 0.112 0.120 0.109 0.172...   % M parameters
                 0.0431 10 0.104 0.181...      % EC parameters
                 9.485 40 0.2996 0.064 0.101 0.01]; % F parameters % These values may be updated during optimization  


% 4.015 0.05 0.015 0.255 0.015 0.167 0.184 0.010 0.172 0.031 0.181 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		33.38 6.74 21.82 11.75 7.00 19.32
        %18.39 6.84 16.77 15.87 2.71 39.42 
       52.2 0.520 5.37 2.05 0.506 36.53 
		];
...
inputs.PEsol.global_theta_guess=[4.015 0.05 0.015 0.255 0.015 0.167 0.184 0.010 0.172 0.031 0.181 9.485 0.001];
