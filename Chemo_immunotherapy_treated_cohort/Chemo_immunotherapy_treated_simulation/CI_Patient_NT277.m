% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT277.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_74';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p74';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		34.64 2.62 5.54 3.42 3.37 50.44
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.01 0.518 33.58 7.89 0.506 52.59 
		];
