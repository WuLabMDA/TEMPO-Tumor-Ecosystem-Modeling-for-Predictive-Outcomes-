% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT046.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_11';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p11';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.108 60 0.102 0.122 0.051 0.114 0.508 0.124 0.291 0.131 0.038 0.126 0.113 0.131 0.189...   % CC parameters
                 0.0355 15 0.189 0.159 0.099 0.098 0.091 0.555 0.131 0.127 0.1795...   % Treg parameters
                 0.01015 15 0.114 0.081 0.324 0.287 0.552 0.124 0.249... % Teff parameters
                 0.010 15 0.23 0.206 0.054 0.06 0.100 0.209 0.185...   % M parameters
                 0.091 10 0.121 0.195...      % EC parameters
                 9.085 75 0.5696 0.034 0.138 0.001]; % F parameters % These values may be updated during optimization  

% 0.108 0.189 0.0355 0.1795 0.01015 0.287 0.149 0.010 0.185 0.091 0.195 9.085 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		49.10 5.62 11.22 5.70 2.64 25.72
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.16 0.60 7.15 8.22 0.67 40.55 
		];
...
inputs.PEsol.global_theta_guess=[0.108 0.189 0.0355 0.1795 0.01015 0.287 0.149 0.010 0.185 0.091 0.195 9.085 0.001];
