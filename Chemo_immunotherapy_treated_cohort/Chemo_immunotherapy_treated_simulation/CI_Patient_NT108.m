% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT108.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_25';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p25';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		46.78 8.36 17.75 5.13 0.76 21.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       2.15 0.67 36.77 1.06 3.976 40.92 
		];
