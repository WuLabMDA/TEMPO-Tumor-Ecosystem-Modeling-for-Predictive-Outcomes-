% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT262.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_69';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p69';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 ...
                 8.095 35 0.300 0.421 0.128 0.467 0.113  0.105 0.01... % Teff parameters
...
inputs.exps.exp_data{1}=[                              
		51.85 3.40 15.92 1.82 4.03 22.99
        %18.39 6.84 16.77 15.87 2.71 39.42 
       5.74 4.501 25.68 3.36 0.617 50.05 
		];
