% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT164.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_37';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p37';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.255...   % CC parameters
                 0.015 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.195...   % Treg parameters
...
% 0.015 0.255 0.015 0.195 8.095 0.467 0.01 9.510 0.002 0.0431 0.811 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		70.23 1.95 4.92 9.12 2.90 10.84
        %18.39 6.84 16.77 15.87 2.71 39.42 
       3.12 0.75 23.59 33.29 1.60 42.62 
		];
...
inputs.PEsol.global_theta_guess=[0.015 0.255 0.015 0.195 8.095 0.467 0.01 9.510 0.002 0.0431 0.811 9.485 0.001];
