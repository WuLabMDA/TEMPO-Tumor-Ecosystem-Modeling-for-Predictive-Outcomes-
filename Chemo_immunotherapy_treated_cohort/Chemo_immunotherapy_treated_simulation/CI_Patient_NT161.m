% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT161.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_35';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p35';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.15 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.015...   % CC parameters
                 9.0015 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.095...   % Treg parameters
                 0.095 25 0.200 0.121 0.128 0.167 0.113  0.105 0.185... % Teff parameters
                 0.510 10 0.20 0.298 0.1 0.112 0.120 0.109 0.1542...   % M parameters
                 8.0431 10 0.104 0.001...      % EC parameters
                 0.485 80 0.1996 0.064 0.101 0.179]; % F parameters % These values may be updated during optimization  


% 6.15 0.015 4.015 0.095 0.095 0.167 0.184 0.510 0.1542 3.0431 0.001 0.485 0.179
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		1.80 7.00 18.72 44.47 1.28 28.24
        %18.39 6.84 16.77 15.87 2.71 39.42 
       28.67 1.26 15.14 38.96 0.550 10.62 
		];
...
inputs.PEsol.global_theta_guess=[6.15 0.015 9.015 0.095 0.095 0.167 0.184 0.510 0.1542 8.0431 0.001 0.485 0.179];
