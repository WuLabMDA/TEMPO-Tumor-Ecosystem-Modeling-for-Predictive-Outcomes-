% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT253.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_66';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p66';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 0.015 10 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.205...   % Treg parameters
                 8.095 65 0.300 0.421 0.128 0.467 0.113  0.105 0.01... % Teff parameters
...
inputs.exps.exp_data{1}=[                              
		72.10 0.505 1.71 0.80 1.61 25.11
        %18.39 6.84 16.77 15.87 2.71 39.42 
       18.43 0.85 19.27 26.46 3.855 44.87 
		];
