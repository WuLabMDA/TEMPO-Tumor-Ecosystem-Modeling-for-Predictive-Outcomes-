...
close all;
rng('default');
CI_Patient_NT114          % Calls the script with the inputs: 
                           % Model
...
if isfield(results, 'sim') && isfield(results.sim, 'obs')
   ...
   csv_filename = fullfile('V:\dkmarri\Mathematical_Model\AMIGO2_R2019c\AMIGO2_R2019c\IMC_BC_Analysis\Chemotherapy_Immunotherapy', 'RD_CI_Patient_114_simulation_results.csv');
