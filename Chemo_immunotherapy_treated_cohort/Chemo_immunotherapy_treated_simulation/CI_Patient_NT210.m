% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT210.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_49';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p49';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		55.64 7.50 6.67 9.49 2.06 17.67
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.05 0.84 45.51 26.17 4.15 23.17 
		];
