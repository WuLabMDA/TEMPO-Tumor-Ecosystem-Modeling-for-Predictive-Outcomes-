% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT219.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_55';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p55';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[8.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.001...   % CC parameters
                 0.015 15 0.22 0.180 0.110 0.328 0.0099 0.0134 0.080 0.108 0.225...   % Treg parameters
                 0.095 60 0.100 0.121 0.128 0.167 0.113  0.105 0.198... % Teff parameters
                 9.510 25 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
...
% 8.015 0.001 0.015 0.225 0.095 0.167 0.198 9.510 0.02 8.0431 0.021 0.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		12.12 5.24 49.02 12.84 3.68 15.09
        %18.39 6.84 16.77 15.87 2.71 39.42 
       30.40 0.505 20.55 16.69 0.505 24.89 
		];
...
inputs.PEsol.global_theta_guess=[8.015 0.001 0.015 0.225 0.095 0.167 0.198 9.510 0.02 8.0431 0.021 0.485 0.001];
