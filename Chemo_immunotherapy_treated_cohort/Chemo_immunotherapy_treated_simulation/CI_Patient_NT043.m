% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT043.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_9';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p9';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[2.8915 50 0.115 0.134 0.299 0.123 0.508 0.171 0.329 0.136 0.103 0.132 0.130 0.135 0.00765...   % CC parameters
                 0.0355 15 0.109 0.112 0.114 0.135 0.091 0.127 0.0510 0.1072 0.05005...   % Treg parameters
                 0.04015 45 0.131 0.121 0.12 0.187 0.129  0.119 0.09259... % Teff parameters
                 0.010 15 0.201 0.307 0.119 0.102 0.100 0.128 0.00025...   % M parameters
                 6.7091 20 0.124 0.095...      % EC parameters
                 8.085 35 1.0596 0.31 0.103 0.01]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		40.90 10.08 34.68 5.51 2.26 6.58 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        9.71 1.92 14.08 1.88 9.626 20.14 
		];
...
inputs.PEsol.global_theta_guess=[2.8915 0.00765 0.0355 0.05005 0.04015 0.187 0.09259 0.010 0.00025 6.7091 0.095 8.085 0.01];
