% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT032.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_7';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p7';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.011 65 0.059 0.73 0.067 0.115 0.408 0.138 0.127 0.129 0.043 0.132 0.124 0.135 0.215...   % CC parameters
                 0.0305 10 0.121 0.107 0.102 0.120 0.085 0.126 0.1620 0.134 0.199...   % Treg parameters
                 7.01015 30 0.326 0.407 0.313 0.457 0.167  0.128 0.06259... % Teff parameters
                 0.010 10 0.133 0.106 0.087 0.094 0.090 0.127 0.145...   % M parameters
                 0.021 10 0.118 0.125...      % EC parameters
                 8.085 60 0.5696 0.204 0.134 0.0101]; % F parameters % These values may be updated during optimization  

% 0.0915 0.215 0.0305 0.199 7.01015 0.457 0.06259 0.010 0.145 0.091 0.125 8.085
...
inputs.exps.exp_data{1}=[                              
		53.55 6.09 1.21 2.28 4.50 10.37 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.05 0.651 30.54 1.65 0.81 32.60 
		];
...
inputs.PEsol.global_theta_guess=[0.011 0.215 0.0305 0.199 7.01015 0.457 0.06259 0.010 0.145 0.021 0.125 8.085 0.0101];
