...
function meanData = calculateMeanPCRData()
    % Import the consolidated data file
    try
        % Attempt to read the consolidated data file
        consolidatedData = readtable('Chemotherapy_Immunotherapy_Consolidated_PCR_Data.csv');
        fprintf('Successfully imported Chemotherapy_Immunotherapy_Consolidated_PCR_Data.csv\n');
    catch e
    ...
    outputFile = 'Chemotherapy_Immunotherapy_Mean_PCR_Data.csv';
...
function plotMeanData(meanData, cellTypes)
    ...
    saveas(gcf, 'Chemotherapy_Immunotherapy_PCR_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_Immunotherapy_PCR_Cell_Type_Mean_Values.fig');
    ...
    saveas(gcf, 'Chemotherapy_Immunotherapy_PCR_Combined_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_Immunotherapy_PCR  _Combined_Cell_Type_Mean_Values.fig');
    fprintf('Combined plot saved as Combined_Cell_Type_Mean_Values.png and Combined_Cell_Type_Mean_Values.fig\n');
end

% Execute the function
meanData = calculateMeanPCRData();