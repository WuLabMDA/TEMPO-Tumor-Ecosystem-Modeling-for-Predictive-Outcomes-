% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT211.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_50';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p50';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		69.67 1.77 1.47 0.57 5.12 23.33
        %18.39 6.84 16.77 15.87 2.71 39.42 
       13.65 0.506 18.48 2.12 13.33 52.34 
		];
