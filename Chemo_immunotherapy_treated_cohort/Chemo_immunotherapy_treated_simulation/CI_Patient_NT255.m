% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT255.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_67';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p67';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		67.29 1.70 8.82 0.507 2.08 19.73
        %18.39 6.84 16.77 15.87 2.71 39.42 
       20.78 0.51 39.78 7.82 0.501 31.23 
		];
