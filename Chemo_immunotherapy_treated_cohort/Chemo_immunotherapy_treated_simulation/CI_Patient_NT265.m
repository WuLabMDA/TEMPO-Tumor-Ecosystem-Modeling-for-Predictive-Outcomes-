% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT265.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_70';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p70';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 ...
                 8.095 10 0.300 0.421 0.128 0.467 0.113  0.105 0.01... % Teff parameters
                 9.510 10 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
                 0.0431 5 0.104 0.021...      % EC parameters
                 9.485 15 0.5996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		80.10 1.9005 9.71 1.501 3.46 3.46
        %18.39 6.84 16.77 15.87 2.71 39.42 
       93.85 0.5071 1.22 0.54 0.58 0.614 
		];
