% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT148.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_33';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p33';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.255...   % CC parameters
                 8.015 10 0.22 0.180 0.110 0.128 0.0099 0.0134 0.080 0.138 0.005...   % Treg parameters
                 9.015 25 0.330 0.511 0.128 0.467 0.113  0.105 0.0045... % Teff parameters
                 0.510 10 0.20 0.298 0.1 0.112 0.120 0.109 0.0542...   % M parameters
                 6.0431 10 0.104 0.001...      % EC parameters
                 0.485 40 0.2996 0.064 0.101 0.121]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		67.84 2.61 7.45 2.54 0.95 18.60
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.52 5.06 79.02 2.78 4.71 7.72 
		];
