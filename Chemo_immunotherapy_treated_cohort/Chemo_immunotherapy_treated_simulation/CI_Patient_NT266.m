% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT266.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_71';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p71';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		57.62 4.01 21.06 7.66 3.07 6.57
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.04 0.502 53.54 34.55 0.501 11.47 
		];
