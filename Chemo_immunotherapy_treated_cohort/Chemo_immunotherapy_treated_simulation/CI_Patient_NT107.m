% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT107.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_24';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p24';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		46.39 7.36 18.17 5.11 3.33 19.64
        %18.39 6.84 16.77 15.87 2.71 39.42 
       7.44 4.02 32.63 11.36 0.615 40.92 
		];
