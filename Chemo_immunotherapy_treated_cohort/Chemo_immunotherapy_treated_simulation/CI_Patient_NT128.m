% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT128.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_30';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p30';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.115 75 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.164...   % CC parameters
                 8.015 10 0.32 0.230 0.110 0.128 0.0099 0.0134 0.080 0.118 0.005...   % Treg parameters
                 7.015 30 0.430 0.311 0.128 0.467 0.113  0.105 0.024... % Teff parameters
                 7.010 10 0.40 0.298 0.1 0.112 0.120 0.109 0.002...   % M parameters
                 0.00431 10 0.104 0.181...      % EC parameters
                 9.485 55 0.2696 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.115 0.164 8.015 0.005 7.015 0.467 0.024 7.010 0.002 0.00431 0.181 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		62.26 1.34 4.81 0.53 2.98 28.06
        %18.39 6.84 16.77 15.87 2.71 39.42 
       30.96 2.95 18.69 3.66 2.34 40.82 
		];
...
inputs.PEsol.global_theta_guess=[0.115 0.164 8.015 0.005 7.015 0.467 0.024 7.010 0.002 0.00431 0.181 9.485 0.001];
