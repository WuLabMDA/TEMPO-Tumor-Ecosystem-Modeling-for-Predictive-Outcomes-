% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT212.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_51';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p51';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 45 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 0.015 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.205...   % Treg parameters
                 8.095 25 0.300 0.421 0.128 0.467 0.113  0.105 0.01... % Teff parameters
                 9.510 50 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
                 8.0431 15 0.104 0.021...      % EC parameters
                 9.485 50 0.1996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		30.67 1.77 6.419 13.64 8.02 39.60
        %18.39 6.84 16.77 15.87 2.71 39.42 
       16.96 0.77 16.78 34.49 0.84 21.69 
		];
