% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT103.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_22';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p22';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0915 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.254...   % CC parameters
                 0.015 15 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 7.015 35 0.330 0.411 0.128 0.447 0.113  0.105 0.001... % Teff parameters
                 0.010 15 0.10 0.198 0.1 0.112 0.120 0.109 0.182...   % M parameters
                 0.031 10 0.104 0.197...      % EC parameters
                 9.485 80 0.9696 0.064 0.110 0.001]; % F parameters % These values may be updated during optimization  


% 0.0915 0.254 0.015 0.255 7.015 0.447 0.001 0.010 0.182 0.031 0.197 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		50.84 4.45 6.83 7.65 3.65 20.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.50 2.501 29.15 2.72 0.606 40.92 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.254 0.015 0.255 7.015 0.447 0.001 0.010 0.182 0.031 0.197 9.485 0.001];
