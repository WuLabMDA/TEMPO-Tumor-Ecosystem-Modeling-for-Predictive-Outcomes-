% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT048.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_12';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p12';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 45 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 ...
                 7.015 30 0.330 0.411 0.228 0.467 0.113  0.105 0.0259... % Teff parameters
                 3.10 30 0.60 0.898 0.7 0.112 0.120 0.109 0.125...   % M parameters
                 0.091 10 0.104 0.155...      % EC parameters
                 9.185 70 0.1696 0.064 0.0138 0.01]; % F parameters % These values may be updated during optimization  


% 0.0915 0.235 0.955 0.185 7.015 0.467 0.0259 3.10 0.0025 0.7091 0.155 9.185 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		29.65 2.17 7.13 10.18 1.60 40.17
        %18.39 6.84 16.77 15.87 2.71 39.42 
        6.73 0.501 25.15 22.31 0.60 26.91 
		];
...
inputs.PEsol.global_theta_guess=[0.0115 0.235 0.015 0.185 7.015 0.467 0.0259 3.10 0.0025 0.091 0.155 9.185 0.001];
