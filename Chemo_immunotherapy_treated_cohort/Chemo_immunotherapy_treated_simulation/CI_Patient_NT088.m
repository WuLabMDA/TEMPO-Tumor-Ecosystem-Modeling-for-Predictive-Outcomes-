% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT088.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_19';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p19';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 40 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 ...
                 8.015 20 0.430 0.511 0.228 0.467 0.113  0.105 0.002... % Teff parameters
                 0.010 25 0.60 0.898 0.7 0.112 0.120 0.109 0.195...   % M parameters
                 0.031 10 0.104 0.175...      % EC parameters
                 9.485 75 0.1696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 0.0915 0.235 0.015 0.205 8.015 0.467 0.002 0.010 0.195 0.031 0.175 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		56.84 3.48 2.83 4.13 7.65 19.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
        6.50 0.80 25.15 5.02 1.06 36.92 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.235 0.015 0.255 8.015 0.467 0.002 0.010 0.195 0.031 0.175 9.485 0.001];
