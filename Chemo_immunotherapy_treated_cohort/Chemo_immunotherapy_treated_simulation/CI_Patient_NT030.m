% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT030.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_6';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p6';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.08915 55 0.098 0.138 0.061 0.119 0.408 0.233 0.32 0.134 0.08 0.130 0.120 0.120 0.205...   % CC parameters
                 0.0355 20 0.43 0.164 0.093 0.126 0.061 0.368 0.093 0.111 0.109...   % Treg parameters
                 7.1015 40 0.324 0.496 0.438 0.587 0.105  0.071 0.009259... % Teff parameters
                 3.010 15 0.127 0.376 0.11 0.08 0.100 0.119 0.0025...   % M parameters
                 0.091 15 0.119 0.205...      % EC parameters
                 9.885 55 0.311 0.106 0.109 0.00301]; % F parameters % These values may be updated during optimization  

% 0.08915 0.185 0.0355 0.109 7.1015 0.587 0.009259 3.010 0.0025 0.091 0.095 8.085 0.0301  
%==================================
% EXPERIMENTAL SCHEME RELATED DATA
%==================================
 inputs.exps.n_exp=1;                                  %Number of experiments                                                                            
 for iexp=1:inputs.exps.n_exp   
 inputs.exps.exp_y0{iexp}=[45.65 9.41 3.15 4.36 3.85 20.58];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		45.65 9.41 3.15 4.36 3.85 20.58 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.50 1.030 33.0 6.48 10.63 30.47 
		];
...
inputs.PEsol.global_theta_guess=[0.08915 0.205 0.0355 0.109 7.1015 0.587 0.009259 3.010 0.0025 0.091 0.205 9.885 0.00301];
...
% OPTIMIZATION
%
inputs.nlpsol.nlpsolver='de';                        % [] NLP solver: 
