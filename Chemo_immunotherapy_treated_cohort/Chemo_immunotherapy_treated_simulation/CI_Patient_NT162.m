% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT162.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_36';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p36';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 75 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 0.015 16 0.12 0.110 0.110 0.128 0.0099 0.0134 0.080 0.138 0.195...   % Treg parameters
                 0.095 25 0.200 0.121 0.128 0.167 0.113  0.105 0.185... % Teff parameters
                 0.110 10 0.20 0.298 0.1 0.112 0.120 0.109 0.1542...   % M parameters
                 0.00431 10 0.104 0.181...      % EC parameters
                 8.485 60 0.2996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.05 0.215 0.015 0.195 0.095 0.167 0.184 0.510 0.1542 0.00431 0.181 8.485 0.009
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		60.00 2.67 8.13 6.42 2.70 20.14
        %18.39 6.84 16.77 15.87 2.71 39.42 
       49.53 8.501 1.04 0.511 0.60 1.31 
		];
...
inputs.PEsol.global_theta_guess=[0.15 0.155 0.015 0.195 0.095 0.167 0.184 0.510 0.1542 0.00431 0.181 8.485 0.001];
