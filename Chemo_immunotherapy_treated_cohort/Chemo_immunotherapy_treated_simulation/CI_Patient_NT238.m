% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT238.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_64';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p64';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.015 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.005...   % CC parameters
                 0.015 30 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.005...   % Treg parameters
                 0.095 65 0.100 0.121 0.128 0.167 0.113  0.105 0.189... % Teff parameters
                 9.510 40 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
                 0.0431 10 0.104 0.171...      % EC parameters
                 0.485 40 0.1996 0.064 0.101 0.167]; % F parameters % These values may be updated during optimization  


% 9.015 0.005 0.015 0.205 0.095 0.167 0.189 9.510 0.02 0.0431 0.171 0.485 0.167
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		37.05 3.20 20.38 13.10 6.61 19.66
        %18.39 6.84 16.77 15.87 2.71 39.42 
       88.65 5.08 3.84 1.51 0.89 1.34 
		];
...
inputs.PEsol.global_theta_guess=[9.015 0.005 0.015 0.205 0.095 0.167 0.189 9.510 0.02 0.0431 0.171 0.485 0.167];
