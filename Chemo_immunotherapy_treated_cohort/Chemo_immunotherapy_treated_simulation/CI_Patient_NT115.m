% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT115.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_28';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p28';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.00915 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.254...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 9.015 25 0.430 0.311 0.128 0.467 0.113  0.105 0.0024... % Teff parameters
                 7.010 10 0.20 0.298 0.1 0.112 0.120 0.109 0.0152...   % M parameters
                 8.0431 10 0.104 0.001...      % EC parameters
                 9.485 25 0.1696 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.00915 0.255 0.015 0.255 9.015 0.467 0.0024 7.010 0.015 8.031 0.001 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		73.36 1.48 5.03 3.49 1.65 14.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.32 0.505 47.97 16.41 4.66 26.10 
		];
...
inputs.PEsol.global_theta_guess=[0.00915 0.255 0.015 0.255 9.015 0.467 0.0024 7.010 0.015 8.031 0.001 9.485 0.001];
