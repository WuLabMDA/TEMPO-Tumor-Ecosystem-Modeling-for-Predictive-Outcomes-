...
close all;
rng('default');
CI_Patient_NT011   % Calls the script with the inputs: 
                           % Model
...
if isfield(results, 'sim') && isfield(results.sim, 'obs')
   ...
   csv_filename = fullfile('W:\dkmarri\Mathematical_Model\AMIGO2_R2019c\AMIGO2_R2019c\IMC_BC_Analysis\Chemotherapy_Immunotherapy', 'PCR_CI_Patient_011_simulation_results.csv');
