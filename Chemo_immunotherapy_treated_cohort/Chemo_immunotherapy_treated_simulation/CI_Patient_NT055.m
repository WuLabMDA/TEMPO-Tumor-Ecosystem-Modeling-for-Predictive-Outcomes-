% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT055.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_15';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p15';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 40 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.205...   % Treg parameters
                 7.015 20 0.330 0.411 0.228 0.467 0.113  0.105 0.00259... % Teff parameters
                 8.10 25 0.60 0.898 0.7 0.112 0.120 0.109 0.0025...   % M parameters
                 6.091 10 0.104 0.00155...      % EC parameters
                 9.185 75 0.1696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 0.0915 0.235 0.955 0.185 7.015 0.467 0.00259 8.10 0.0025 6.091 0.00155 9.185 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		29.65 3.57 4.92 2.28 0.506 62.24
        %18.39 6.84 16.77 15.87 2.71 39.42 
        3.79 0.61 20.15 7.85 4.77 43.92 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.235 0.955 0.185 7.015 0.467 0.00259 8.10 0.0025 6.091 0.00155 9.185 0.001];
