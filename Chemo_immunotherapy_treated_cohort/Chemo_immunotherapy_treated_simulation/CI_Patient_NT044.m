% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT044.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_10';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p10';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.8915 50 0.277 0.317 0.199 0.119 0.508 0.113 0.21 0.134 0.038 0.130 0.125 0.207 0.0205...   % CC parameters
                 0.0355 15 0.112 0.125 0.114 0.135 0.091 0.126 0.0510 0.137 0.10905...   % Treg parameters
                 0.01015 30 0.131 0.121 0.12 0.187 0.128  0.117 0.09259... % Teff parameters
                 0.010 35 0.200 0.306 0.119 0.102 0.100 0.108 0.185...   % M parameters
                 0.091 15 0.124 0.195...      % EC parameters
                 1.085 80 0.5696 0.064 0.138 0.01]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		26.99 3.57 4.92 2.28 2.1 52.24
        %18.39 6.84 16.77 15.87 2.71 39.42 
        8.79 0.80 29.5 0.65 0.67 62.92 
		];
...
inputs.PEsol.id_global_theta=char('Gr_cc', 'mu_cc',...
                            'Gr_treg', 'mu_treg',...
                            'Gr_teff','mu_teff','k_immun',...
                            'Gr_m','mu_m',...
                            'Gr_ec','mu_ec',...
                            'Gr_f','mu_f');  %  'all'|User selected 
inputs.PEsol.global_theta_guess=[0.8915 0.0205 0.0355 0.10905 0.01015 0.187 0.09259 0.010 0.185 0.091 0.195 1.085 0.01];
