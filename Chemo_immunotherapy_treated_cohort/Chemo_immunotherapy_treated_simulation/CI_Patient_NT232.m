% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT232.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_61';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p61';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 ...
                 9.510 15 0.30 0.298 0.1 0.112 0.120 0.109 0.02...   % M parameters
...
inputs.exps.exp_data{1}=[                              
		68.87 4.65 4.13 8.86 0.83 12.68
        %18.39 6.84 16.77 15.87 2.71 39.42 
       10.91 6.53 30.48 12.20 3.25 40.85 
		];
