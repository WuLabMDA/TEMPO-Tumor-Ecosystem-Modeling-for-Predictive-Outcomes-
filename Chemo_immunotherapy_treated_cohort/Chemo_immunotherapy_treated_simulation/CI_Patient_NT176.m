% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT176.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_40';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p40';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[5.015 45 0.216 0.303 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.130 0.118 0.005...   % CC parameters
                 0.015 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.215...   % Treg parameters
                 0.095 45 0.100 0.121 0.128 0.167 0.113  0.105 0.211... % Teff parameters
                 0.0910 20 0.30 0.298 0.1 0.112 0.120 0.109 0.162...   % M parameters
                 0.0431 10 0.104 0.161...      % EC parameters
                 9.485 70 0.2996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 5.015 0.005 0.015 0.215 0.095 0.167 0.211 0.0910 0.162 0.0431 0.161 0.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		18.59 6.78 32.15 12.50 3.98 26.27
        %18.39 6.84 16.77 15.87 2.71 39.42 
       4.48 1.58 20.46 4.95 3.98 50.46 
		];
...
inputs.PEsol.global_theta_guess=[5.015 0.005 0.015 0.215 0.095 0.167 0.211 0.0910 0.162 0.0431 0.161 0.485 0.001];
