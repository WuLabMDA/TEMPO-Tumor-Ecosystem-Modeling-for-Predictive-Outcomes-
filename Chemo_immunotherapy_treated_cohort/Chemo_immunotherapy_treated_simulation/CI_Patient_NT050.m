...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_13';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p13';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0015 10 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.205...   % CC parameters
                 0.015 15 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.215...   % Treg parameters
                 0.015 65 0.130 0.111 0.028 0.167 0.113  0.105 0.259... % Teff parameters
                 7.10 35 0.60 0.898 0.7 0.112 0.120 0.109 0.0025...   % M parameters
                 0.091 10 0.104 0.155...      % EC parameters
                 9.185 65 0.1696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 0.0015 0.205 0.015 0.215 0.015 0.167 0.189 7.10 0.0025 0.091 0.155 9.185 0.001
% 
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		6.54 8.49 54.38 16.33 4.18 10.08
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.06 0.66 19.88 23.68 0.77 30.45 
		];
...
inputs.PEsol.global_theta_guess=[0.0015 0.205 0.015 0.215 0.015 0.167 0.259 7.10 0.0025 0.091 0.155 9.185 0.001];
