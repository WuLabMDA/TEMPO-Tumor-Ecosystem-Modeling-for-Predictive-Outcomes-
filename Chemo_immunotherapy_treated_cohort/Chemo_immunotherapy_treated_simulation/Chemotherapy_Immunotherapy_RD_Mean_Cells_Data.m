...
function meanData = calculateMeanRDData()
    ...
    try
        ...
        consolidatedData = readtable('Chemotherapy_Immunotherapy_Consolidated_RD_Data.csv');
        fprintf('Successfully imported Chemotherapy_Immunotherapy_Consolidated_RD_Data.csv\n');
    catch e
    ...
    outputFile = 'Chemotherapy_Immunotherapy_Mean_RD_Data.csv';
...
function plotMeanData(meanData, cellTypes)
    ...
    saveas(gcf, 'Chemotherapy_Immunotherapy_RD_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_Immunotherapy_RD_Cell_Type_Mean_Values.fig');
    ...
    saveas(gcf, 'Chemotherapy_Immunotherapy_RD_Combined_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_Immunotherapy_RD_Combined_Cell_Type_Mean_Values.fig');
