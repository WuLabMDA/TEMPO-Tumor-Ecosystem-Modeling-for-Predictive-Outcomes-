% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT028.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_5';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p5';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[8.8915 50 0.107 0.317 0.060 0.119 0.308 0.113 0.208 0.135 0.042 0.130 0.125 0.108 0.000205...   % CC parameters
                 0.0355 20 0.112 0.125 0.0985 0.132 0.0932 0.125 0.0597 0.127 0.105...   % Treg parameters
                 0.0815 50 0.131 0.121 0.12 0.137 0.141  0.117 0.1309... % Teff parameters
                 3.010 15 0.114 0.384 0.0955 0.087 0.100 0.121 0.025...   % M parameters
                 0.0091 15 0.086 0.095...      % EC parameters
                 0.085 30 0.08 0.246 0.108 0.121]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		9.67 12.80 43.00 2.00 9.29 20.44 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        41.49 1.17 12.66 8.48 1.073 3.47 
		];
...
inputs.PEsol.global_theta_guess=[8.8915 0.000205 0.0355 0.105 0.0815 0.137 0.1309 3.010 0.025 0.0091 0.095 0.085 0.121];
