% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT050.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_16';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p16';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 40 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 ...
                 0.015 20 0.130 0.111 0.228 0.167 0.113  0.105 0.189... % Teff parameters
                 0.010 25 0.10 0.198 0.7 0.112 0.120 0.109 0.185...   % M parameters
                 0.091 10 0.104 0.155...      % EC parameters
                 9.185 75 0.696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 0.0915 0.235 0.015 0.205 0.015 0.167 0.189 0.010 0.185 0.091 0.155 9.185 0.001
% 
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[13.09 13.57 3.83 36.13 2.65 10.54];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		13.09 13.57 3.83 36.13 2.65 10.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.79 0.51 22.15 1.02 0.506 46.92 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.235 0.015 0.205 0.015 0.167 0.189 0.010 0.185 0.091 0.155 9.185 0.001];
