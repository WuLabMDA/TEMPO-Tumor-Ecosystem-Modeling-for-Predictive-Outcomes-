% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT098.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_20';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p20';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.0115 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.004...   % CC parameters
                 ...
                 8.010 10 0.60 0.898 0.7 0.112 0.120 0.109 0.002...   % M parameters
                 7.431 10 0.104 0.006...      % EC parameters
                 9.485 25 0.1696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 9.0915 0.004 0.015 0.255 0.015 0.147 0.198 8.010 0.002 7.431 0.006 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		69.56 1.48 14.14 2.99 1.73 13.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
        85.78 0.507 2.73 0.66 0.76 1.30
		];
...
inputs.PEsol.global_theta_guess=[9.0915 0.004 0.015 0.255 0.015 0.147 0.198 8.010 0.002 7.431 0.006 9.485 0.001];
