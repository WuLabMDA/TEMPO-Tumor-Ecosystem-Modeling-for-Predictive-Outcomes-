% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_NT017.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_4';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p4';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[2.8915 55 0.115 0.134 0.299 0.123 0.208 0.171 0.329 0.136 0.103 0.132 0.130 0.135 0.099...   % CC parameters
                 0.0355 10 0.109 0.112 0.114 0.135 0.091 0.127 0.0510 0.1072 0.117...   % Treg parameters
                 0.04015 10 0.131 0.121 0.12 0.287 0.129  0.119 0.119... % Teff parameters
                 0.010 10 0.201 0.307 0.119 0.102 0.100 0.128 0.125...   % M parameters
                 0.291 10 0.124 0.109...      % EC parameters
                 0.485 70 1.0596 0.31 0.103 0.11]; % F parameters % These values may be updated during optimization  

% 2.8915 0.099 0.0355 0.117 0.04015 0.287 0.119 0.010 0.125 0.291 0.109 0.485 0.11
%  
%==================================
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[28.82 4.58 5.06 5.65 4.68 57.97];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		28.82 4.58 5.06 5.65 4.68 57.97 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        49.88 0.59 1.144 0.65 0.69 3.39 
		];
...
inputs.PEsol.global_theta_guess=[2.8915 0.099 0.0355 0.117 0.04015 0.287 0.119 0.010 0.125 0.291 0.109 0.485 0.11];
