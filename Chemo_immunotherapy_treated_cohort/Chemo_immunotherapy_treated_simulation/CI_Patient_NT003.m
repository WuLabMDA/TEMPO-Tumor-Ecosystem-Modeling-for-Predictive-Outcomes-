% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy_Immunotherapy/Chemo_Immuno_Patient_NT003.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_2';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p2';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0915 80 0.121 0.313 0.065 0.128 0.188 0.128 0.181 0.137 0.216 0.132 0.129 0.136 0.215...   % CC parameters
                 0.1555 10 0.14 0.128 0.111 0.134 0.103 0.132 0.108 0.120 0.145...   % Treg parameters
                 4.015 35 0.330 0.221 0.138 0.307 0.133  0.105 0.0459... % Teff parameters
                 0.030 10 0.122 0.076 0.132 0.081 0.090 0.126 0.215...   % M parameters
                 0.0371 10 0.134 0.195...      % EC parameters
                9.085 70 0.06 0.274 0.130 0.021]; % F parameters % These values may be updated during optimization  

% 0.0915 0.165 0.0555 0.185 6.015 0.0459 0.030 0.215 0.0371 0.195 9.085 0.021
%==================================
% EXPERIMENTAL SCHEME RELATED DATA
%==================================
 inputs.exps.n_exp=1;                                  %Number of experiments                                                                            
 for iexp=1:inputs.exps.n_exp   
 inputs.exps.exp_y0{iexp}=[66.18 3.37 9.86 5.24 2.05 16.32];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		66.18 3.37 9.86 5.24 2.05 16.32 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        5.16 1.2 25.88 0.71 0.85 56.18 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.215 0.0555 0.145 4.015 0.307 0.0459 0.030 0.215 0.0371 0.195 9.085 0.021];
