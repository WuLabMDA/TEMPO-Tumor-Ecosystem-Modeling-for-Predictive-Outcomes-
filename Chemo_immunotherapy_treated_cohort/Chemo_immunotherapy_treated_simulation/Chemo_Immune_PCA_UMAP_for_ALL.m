...
%% ---------------- Load the Data ----------------
filePCR = 'Chemotherapy_Immunotherapy_Consolidated_PCR_Data.csv';
fileRD  = 'Chemotherapy_Immunotherapy_Consolidated_RD_Data.csv';
...
writetable(UMAP_data_table, 'Chemo_Immuno_UMAP_CellType_PCR_RD.csv');
