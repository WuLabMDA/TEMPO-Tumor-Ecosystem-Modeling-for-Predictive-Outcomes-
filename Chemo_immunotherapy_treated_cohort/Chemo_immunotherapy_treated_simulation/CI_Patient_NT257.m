% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT257.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_68';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p68';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		42.07 4.10 13.65 2.77 7.17 30.27
        %18.39 6.84 16.77 15.87 2.71 39.42 
       6.98 0.54 30.42 6.505 8.38 52.66 
		];
