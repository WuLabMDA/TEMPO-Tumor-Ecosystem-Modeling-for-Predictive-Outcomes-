% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT122.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_29';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p29';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.00915 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.254...   % CC parameters
                 ...
                 7.010 10 0.20 0.298 0.1 0.112 0.120 0.109 0.002...   % M parameters
                 0.0431 10 0.104 0.181...      % EC parameters
                 9.485 25 0.2696 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.00915 0.255 0.015 0.255 9.015 0.467 0.0024 7.010 0.165 0.031 0.181 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		76.69 1.48 3.83 1.82 5.65 11.63
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.50 0.505 30.15 20.45 3.66 27.38 
		];
...
inputs.PEsol.global_theta_guess=[0.00915 0.255 0.015 0.255 9.015 0.467 0.0024 7.010 0.002 0.031 0.181 9.485 0.001];
