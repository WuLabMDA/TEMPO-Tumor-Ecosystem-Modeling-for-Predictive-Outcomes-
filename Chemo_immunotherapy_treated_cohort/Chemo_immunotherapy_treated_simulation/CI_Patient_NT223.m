% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT223.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_57';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p57';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.05...   % CC parameters
...
inputs.exps.exp_data{1}=[                              
		22.87 2.57 29.97 1.83 8.39 34.34
        %18.39 6.84 16.77 15.87 2.71 39.42 
       17.80 0.506 24.73 14.60 0.506 43.21 
		];
...
inputs.PEsol.global_theta_guess=[9.015 0.05 0.015 0.205 8.095 0.467 0.01 9.510 0.02 8.0431 0.021 0.485 0.001];
