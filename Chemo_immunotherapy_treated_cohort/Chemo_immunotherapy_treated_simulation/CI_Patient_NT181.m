% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT181.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_43';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p43';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
...
inputs.exps.exp_data{1}=[                              
		43.13 8.13 8.86 6.57 3.60 29.56
        %18.39 6.84 16.77 15.87 2.71 39.42 
       5.79 0.505 38.48 3.44 3.95 52.36 
		];
