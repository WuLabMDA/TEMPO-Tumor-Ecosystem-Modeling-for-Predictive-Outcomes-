% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT171.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_38';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p38';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 0.015 15 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.105...   % Treg parameters
                 8.095 25 0.300 0.421 0.128 0.467 0.113  0.105 0.01... % Teff parameters
                 9.510 10 0.30 0.298 0.1 0.112 0.120 0.109 0.002...   % M parameters
                 0.0431 10 0.104 0.181...      % EC parameters
                 0.485 80 0.1996 0.064 0.101 0.091]; % F parameters % These values may be updated during optimization  


% 0.015 0.215 0.015 0.105 8.095 0.467 0.01 9.510 0.002 0.0431 0.811 0.485 0.091
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		62.02 2.34 9.65 1.38 1.58 23.03
        %18.39 6.84 16.77 15.87 2.71 39.42 
       39.12 0.75 23.59 13.77 1.54 21.40 
		];
...
inputs.PEsol.global_theta_guess=[0.015 0.215 0.015 0.105 8.095 0.467 0.01 9.510 0.002 0.0431 0.811 0.485 0.091];
