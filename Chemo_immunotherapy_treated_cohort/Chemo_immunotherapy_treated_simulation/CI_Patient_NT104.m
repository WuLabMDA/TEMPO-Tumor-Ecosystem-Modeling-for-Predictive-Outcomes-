% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT104.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_23';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p23';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0115 45 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.178 0.235...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 0.015 30 0.130 0.211 0.228 0.267 0.113  0.135 0.259... % Teff parameters
                 3.10 30 0.60 0.898 0.7 0.112 0.120 0.109 0.125...   % M parameters
                 0.091 10 0.104 0.155...      % EC parameters
                 9.185 70 0.9696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 0.0115 0.235 0.015 0.255 0.015 0.267 0.259 3.010 0.125 0.091 0.155 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		50.41 2.32 20.323 2.63 1.96 20.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       6.39 5.506 18.36 10.47 0.506 35.92 
		];
...
inputs.PEsol.global_theta_guess=[ 0.0115 0.235 0.015 0.255 0.015 0.267 0.259 3.010 0.125 0.091 0.155 9.185 0.001];
