% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT160.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_34';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p34';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.15 60 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.1055...   % CC parameters
                 0.0015 20 0.22 0.180 0.110 0.128 0.0099 0.0134 0.080 0.138 0.215...   % Treg parameters
                 0.015 25 0.030 0.111 0.128 0.067 0.113  0.115 0.205... % Teff parameters
                 0.510 10 0.20 0.298 0.1 0.112 0.120 0.109 0.0542...   % M parameters
                 0.0431 10 0.104 0.191...      % EC parameters
                 9.485 80 0.2996 0.064 0.101 0.001]; % F parameters % These values may be updated during optimization  


% 0.0015 0.255 8.015 0.005 9.015 0.467 0.004 0.510 0.0542 6.0431 0.001 0.485 0.121
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		49.80 8.00 14.72 5.96 4.68 16.84
        %18.39 6.84 16.77 15.87 2.71 39.42 
       10.21 0.5506 20.04 2.02 1.57 55.29 
		];
...
inputs.PEsol.global_theta_guess=[0.0015 0.255 8.015 0.005 9.015 0.467 0.004 0.510 0.0542 6.0431 0.001 0.485 0.121];
