% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT011.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_3';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p3';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0215 50 0.124 1.11 0.038 0.117 0.508 0.133 0.137 0.134 0.118 0.128 0.126 0.134 0.205...   % CC parameters
                 0.0105 15 0.358 0.222 0.115 0.111 0.09 0.212 0.070 0.127 0.1305...   % Treg parameters
                 7.015 50 0.518 0.993 0.101 0.487 0.123  0.117 0.0259... % Teff parameters
                 3.090 10 0.236 0.77 0.108 0.103 0.120 0.101 0.025...   % M parameters
                 0.07091 10 0.103 0.145...      % EC parameters
                 6.085 15 0.09 0.188 0.102 0.05]; % F parameters % These values may be updated during optimization  

% 0.0215 0.205 0.0105 0.1305 7.015 0.487 0.0259 3.090 0.025 0.07091 0.145 6.085 0.05
%==================================
...
inputs.exps.exp_data{1}=[                              
		37.32 8.12 9.40 1.09 2.67 13.41 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        2.74 1.26 35.95 5.21 0.9 01.84 
		];
...
inputs.PEsol.global_theta_guess=[0.0215 0.205 0.0105 0.1305 7.015 0.487 0.0259 3.090 0.025 0.07091 0.145 6.085 0.05];
