% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT221.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_56';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p56';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 70 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.215...   % CC parameters
                 0.015 60 0.72 0.980 0.110 0.328 0.0099 0.0134 0.080 0.108 0.205...   % Treg parameters
...
inputs.exps.exp_data{1}=[                              
		27.87 48.70 11.47 3.90 2.14 6.78
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.05 0.506 38.48 13.68 0.65 49.34 
		];
