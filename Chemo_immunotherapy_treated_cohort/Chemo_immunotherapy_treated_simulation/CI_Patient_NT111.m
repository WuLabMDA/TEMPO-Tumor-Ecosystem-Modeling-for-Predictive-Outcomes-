% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT111.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_26';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p26';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0915 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.184...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 0.015 25 0.130 0.011 0.128 0.147 0.113  0.105 0.218... % Teff parameters
...
inputs.exps.exp_data{1}=[                              
		3.22 14.61 60.99 6.65 1.65 16.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.30 1.43 35.15 0.70 3.66 47.92 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.185 0.015 0.255 0.015 0.147 0.218 0.010 0.165 0.031 0.175 9.485 0.001];
