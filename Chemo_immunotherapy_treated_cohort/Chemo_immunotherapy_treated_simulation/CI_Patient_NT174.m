% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT174.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_39';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p39';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		15.59 12.77 52.89 4.98 1.76 12.02
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.79 1.84 68.54 6.36 3.65 17.83 
		];
