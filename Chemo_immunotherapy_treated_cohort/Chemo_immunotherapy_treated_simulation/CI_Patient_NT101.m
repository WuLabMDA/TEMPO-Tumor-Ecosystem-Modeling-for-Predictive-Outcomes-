% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT101.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_21';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p21';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[8.0915 100 0.116 0.103 0.098 0.126 0.388 0.122 0.224 0.135 0.618 0.333 0.230 0.118 0.004...   % CC parameters
                 0.015 10 0.12 0.130 0.110 0.128 0.0099 0.0134 0.080 0.138 0.255...   % Treg parameters
                 0.015 25 0.130 0.011 0.128 0.147 0.113  0.105 0.198... % Teff parameters
                 0.010 10 0.10 0.198 0.1 0.112 0.120 0.109 0.162...   % M parameters
                 0.0431 10 0.104 0.186...      % EC parameters
                 9.485 25 0.1696 0.064 0.0138 0.001]; % F parameters % These values may be updated during optimization  


% 8.0915 0.005 0.015 0.255 0.015 0.267 0.198 0.010 0.165 0.031 0.175 9.485 0.001
% 
%==================================
...
inputs.exps.exp_data{1}=[                              
		16.84 37.48 22.83 7.13 3.65 20.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
       3.50 0.80 30.15 1.02 2.66 40.92 
		];
...
inputs.PEsol.global_theta_guess=[8.0915 0.005 0.015 0.255 0.015 0.267 0.198 0.010 0.165 0.031 0.175 9.485 0.001];
