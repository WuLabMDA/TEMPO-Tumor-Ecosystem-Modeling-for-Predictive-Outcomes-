% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT237.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_63';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p63';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		55.01 4.66 9.71 1.80 2.84 25.97
        %18.39 6.84 16.77 15.87 2.71 39.42 
       1.34 2.17 48.00 21.89 3.81 18.79 
		];
