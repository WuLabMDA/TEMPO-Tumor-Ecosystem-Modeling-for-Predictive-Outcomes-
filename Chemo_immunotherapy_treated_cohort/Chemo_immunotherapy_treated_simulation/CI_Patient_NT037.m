% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Immuno_Patient_NT037.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemo_immunotherapy_8';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_immuno_p8';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[8.8915 70 0.107 0.117 0.060 0.119 0.208 0.113 0.208 0.135 0.042 0.130 0.125 0.108 0.00205...   % CC parameters
                 0.355 30 0.312 0.125 0.0985 0.132 0.0932 0.125 0.0597 0.127 0.105...   % Treg parameters
                 0.0815 20 0.131 0.121 0.12 0.137 0.141  0.117 0.1309... % Teff parameters
                 7.010 40 0.714 0.984 0.8955 0.087 0.100 0.101 0.0025...   % M parameters
                 0.91 30 0.086 0.195...      % EC parameters
                 2.85 40 0.08 0.246 0.108 0.121]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		54.30 5.05 6.92 6.96 4.30 26.46 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        69.36 0.78 02.80 11.89 01.943 13.47 
		];
