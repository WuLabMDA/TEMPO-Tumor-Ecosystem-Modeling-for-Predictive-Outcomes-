% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT184.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_44';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p44';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 50 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.138 0.243...   % CC parameters
                 0.08 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.130 0.182...   % Treg parameters
                 9.15 50 0.98 0.92 0.98 0.0905 0.0108 0.09035 0.00105... % Teff parameters
                 0.01 20 0.823 0.652 0.101 0.084 0.136 0.15...   % M parameters
                 8.091 15 0.50 0.0005...      % EC parameters
                 0.025 30 0.362 0.108 0.138 0.01]; % F parameters % These values may be updated during optimization  

% 0.012 0.243 0.08 0.182 9.05 0.00105 0.01 0.15 8.091 0.0005 0.025 0.01
...
inputs.exps.exp_data{1}=[                              
		30.48 6.26 33.40 11.83 2.68 15.58
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.123 1.186 80.45 1.42 7.00 4.27 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.243 0.08 0.182 9.05 0.00105 0.01 0.15 8.091 0.0005 0.025 0.01];
