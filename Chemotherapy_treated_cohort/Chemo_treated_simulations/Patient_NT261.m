% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT261.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_69';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p69';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.03 50 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.079 0.203...   % CC parameters
                 0.02 10 0.109 0.149 0.103 0.129 0.085 0.059 0.077 0.064 0.162...   % Treg parameters
                 6.1 10 0.98 0.92 0.98 0.0905 0.0108 0.055 0.005... % Teff parameters
                 5.03 10 0.823 0.652 0.101 0.084 0.096 0.002...   % M parameters
                 8.041 15 0.066 0.0005...      % EC parameters
                 0.025 65 0.362 0.108 0.101 0.15]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		35.78 1.54 3.25 1.14 5.04 53.99
        %18.39 6.84 16.77 15.87 2.71 39.42 
        13.31 0.86 4.506 3.78 7.32 33.99 
		];
...
inputs.PEsol.global_theta_guess=[ 0.03 0.203 0.02 0.162 5.1 0.005 5.03 0.002 8.041 0.0005 0.025 0.151];
