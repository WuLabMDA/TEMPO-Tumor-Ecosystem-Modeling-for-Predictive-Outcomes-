% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT222.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_55';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p55';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 30 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.134 0.203...   % CC parameters
                 0.18 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.103 0.162...   % Treg parameters
                 0.1 40 0.98 0.92 0.98 0.0905 0.0108 0.103 0.195... % Teff parameters
                 0.03 20 0.823 0.652 0.101 0.084 0.096 0.125...   % M parameters
                 0.041 10 0.108 0.0005...      % EC parameters
                 9.025 55 0.362 0.108 0.135 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.203 0.18 0.162 0.1 0.195 0.03 0.125 0.041 0.0005 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[17.32 5.54 30.25 12.66 5.13 29.92];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		17.32 5.54 30.25 12.66 5.13 29.92
        %18.39 6.84 16.77 15.87 2.71 39.42 
        3.123 0.86 5.506 1.41 0.91 33.35 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.203 0.18 0.162 0.1 0.195 0.03 0.125 0.041 0.0005 9.025 0.0001];
