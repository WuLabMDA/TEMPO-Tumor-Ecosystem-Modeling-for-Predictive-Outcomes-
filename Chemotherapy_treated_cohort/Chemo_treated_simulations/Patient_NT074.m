...
inputs.pathd.results_folder='imc_bc_chemotherapy_19';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p19';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 90 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 0.117 0.215...   % CC parameters
                 0.105 15 0.699 0.749 0.103 0.729 0.085 0.059 0.077 0.125 0.1605...   % Treg parameters
                 9.0155 40 0.823 0.703 0.057 0.561 0.109 0.119 0.00190... % Teff parameters
                 0.010 35 0.123 0.452 0.101 0.084 0.147 0.105...   % M parameters
                 10.091 15 0.079 0.0005...      % EC parameters
                 3.85 90 0.362 0.108 0.136 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		59.15 2.21 4.31 1.39 3.60 29.27
        %18.39 6.84 16.77 15.87 2.71 39.42 
        15.22 0.82 24.51 9.39 1.01 41.80 
		];
