% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT047.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_12';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p12';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.12 80 0.655 0.130 0.098 0.122 0.545 0.123 0.201 0.128 0.099 0.132 0.123 0.131 0.205...   % CC parameters
                 7.255 15 0.617 0.739 0.106 0.107 0.089 0.382 0.097 0.119 0.00135...   % Treg parameters
                 4.315 50 0.824 0.707 0.859 0.154 0.103 0.113 0.0920... % Teff parameters
                 5.10 50 0.501 0.673 0.110 0.064 0.123 0.025...   % M parameters
                 9.101 15 0.105 0.000105...      % EC parameters
                 7.85 75 0.901 0.179 0.112 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		68.04 3.19 1.94 2.38 4.38 24.06 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        12.37 0.52 28.02 13.69 0.83 26.84 
		];
...
inputs.PEsol.global_theta_guess=[0.12 0.205 5.255 0.00135 4.315 0.0920 5.10 0.025 9.101 0.000105 7.85 0.001];
