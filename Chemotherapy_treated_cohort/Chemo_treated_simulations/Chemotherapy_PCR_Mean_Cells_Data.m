...
function meanData = calculateMeanPCRData()
    ...
    try
        ...
        consolidatedData = readtable('Chemotherapy_Consolidated_PCR_Data.csv');
        fprintf('Successfully imported Chemotherapy_Consolidated_PCR_Data.csv\n');
    catch e
    ...
    outputFile = 'Chemotherapy_Mean_PCR_Data.csv';
...
function plotMeanData(meanData, cellTypes)
    ...
    saveas(gcf, 'Chemotherapy_PCR_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_PCR_Cell_Type_Mean_Values.fig');
    ...
    saveas(gcf, 'Chemotherapy_PCR_Combined_Cell_Type_Mean_Values.png');
    saveas(gcf, 'Chemotherapy_PCR_Combined_Cell_Type_Mean_Values.fig');
