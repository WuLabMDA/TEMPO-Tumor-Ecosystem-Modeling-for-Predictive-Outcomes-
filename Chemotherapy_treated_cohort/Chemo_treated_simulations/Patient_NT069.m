% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT069.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_16';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p16';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[4.515 65 0.114 0.132 0.056 0.123 0.575 0.129 0.186 0.128 0.135 0.131 0.123 0.105 0.015...   % CC parameters
                 0.065 35 0.464 0.39 0.109 0.104 0.082 0.407 0.085 0.177 0.165...   % Treg parameters
                 0.0155 65 0.125 0.094 0.213 0.4100 0.106 0.111 0.190... % Teff parameters
                 7.010 30 0.123 0.452 0.101 0.084 0.147 0.0025...   % M parameters
                 9.091 25 0.0104 0.005...      % EC parameters
                 9.85 65 0.362 0.108 0.136 0.0001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		14.40 15.56 38.95 5.52 3.95 21.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
        19.07 1.66 17.31 12.99 1.38 35.59 
		];
...
inputs.PEsol.global_theta_guess=[4.415 0.015 0.065 0.105 0.0155 0.120 7.10 0.025 9.091 0.105 9.85 0.0001];
