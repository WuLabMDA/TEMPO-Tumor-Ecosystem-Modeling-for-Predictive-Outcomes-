% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT198.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_53';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p53';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[2.012 85 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.134 0.03...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.077 0.182...   % Treg parameters
                 0.015 35 0.18 0.212 0.138 0.0905 0.0108 0.105 0.190... % Teff parameters
                 5.01 20 0.823 0.652 0.101 0.084 0.130 0.001...   % M parameters
                 0.091 10 0.101 0.05...      % EC parameters
                 9.025 55 0.362 0.108 0.124 0.0001]; % F parameters % These values may be updated during optimization  



% 2.012 0.03 0.08 0.182 0.015 0.190 5.01 0.001 0.091 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[29.56 3.37 19.25 4.43 4.88 38.49];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		29.56 3.37 19.25 4.43 4.88 38.49
        %18.39 6.84 16.77 15.87 2.71 39.42 
        15.21 4.86 0.96 0.91 0.91 18.13 
		];
...
inputs.PEsol.global_theta_guess=[2.012 0.03 0.08 0.182 0.015 0.190 5.01 0.001 0.091 0.05 9.025 0.0001];
