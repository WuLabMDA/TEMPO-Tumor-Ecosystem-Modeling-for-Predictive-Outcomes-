% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT270.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_72';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p72';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.03 50 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.117 0.079 0.213...   % CC parameters
                 0.01 25 0.109 0.149 0.103 0.129 0.085 0.059 0.077 0.119 0.222...   % Treg parameters
                 0.1 45 0.18 0.122 0.108 0.0905 0.0108 0.101 0.135... % Teff parameters
                 0.23 15 0.123 0.102 0.101 0.084 0.163 0.122...   % M parameters
                 0.041 10 0.056 0.105...      % EC parameters
                 9.025 55 0.362 0.108 0.121 0.0001]; % F parameters % These values may be updated during optimization  

% 0.03 0.213 0.01 0.222 0.1 0.135 0.23 0.122 0.041 0.105 9.025 0.001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[27.04 15.43 32.29 8.37 1.98 15.40];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		27.04 15.43 32.29 8.37 1.98 15.40
        %18.39 6.84 16.77 15.87 2.71 39.42 
        3.31 0.86 16.15 0.58 0.91 42.63 
		];
...
inputs.PEsol.global_theta_guess=[0.03 0.213 0.01 0.222 0.1 0.135 0.23 0.122 0.041 0.105 9.025 0.001];
