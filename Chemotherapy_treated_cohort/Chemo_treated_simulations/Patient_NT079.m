% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT079.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_21';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p21';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 90 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.110 0.205...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.098 0.1605...   % Treg parameters
                 0.155 17 0.823 0.703 0.057 0.561 0.109 0.125 0.110... % Teff parameters
                 9.810 35 0.823 0.652 0.101 0.084 0.114 0.0005...   % M parameters
                 1.091 15 0.100 0.095...      % EC parameters
                 9.85 90 0.362 0.108 0.133 0.0001]; % F parameters % These values may be updated during optimization  

% 0.05 0.205 0.08 0.1605 0.0155 0.180 9.010 0.005 1.091 0.095 9.85 0.0001 
%==================================
% EXPERIMENTAL SCHEME RELATED DATA
%==================================
 inputs.exps.n_exp=1;                                  %Number of experiments                                                                            
 for iexp=1:inputs.exps.n_exp   
 inputs.exps.exp_y0{iexp}=[67.97 2.34 7.62 6.19 2.54 14.39];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		67.97 2.34 7.62 6.19 2.54 14.39
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.02 0.86 4.89 11.41 1.47 41.48 
		];
...
inputs.PEsol.global_theta_guess=[0.05 0.205 0.08 0.1605 0.0155 0.180 9.810 0.0005 1.091 0.095 9.85 0.0001];
