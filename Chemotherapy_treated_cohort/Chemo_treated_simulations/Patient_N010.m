% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT010.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_2';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p2';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[1.1 20 0.685 0.2395 0.52 0.12 0.82 0.233 0.131 0.091 0.11 0.122 0.112 0.12 0.17...   % CC parameters
                 0.17 20 0.31 0.32 0.11 0.113 0.08 0.21 0.074 0.11 0.0125...   % Treg parameters
                 3.87 75 0.125 0.099 0.23 0.487 0.12 0.1135 0.0915... % Teff parameters
                 1.65 20 0.21 0.18 0.09 0.09 0.11 0.085...   % M parameters
                 7.15 20 0.10 0.0075...      % EC parameters
                 0.985 20 0.09 0.272 0.09 0.002]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		13.31 9.22 59.05 5.18 3.16 10.07 
        %1.06 9.03 48.02 23.48 4.85 13.56 
        2.07 0.70 54.32 4.12 2.59 1.31 
		];
...
inputs.PEsol.global_theta_guess=[1.1 0.17 0.17 0.0125 3.87 0.0915 1.65 0.085 7.15 0.0075 0.985 0.002];
