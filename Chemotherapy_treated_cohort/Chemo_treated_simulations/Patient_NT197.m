% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT197.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_52';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p52';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 85 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.135 0.243...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.098 0.182...   % Treg parameters
                 9.15 35 0.98 0.92 0.98 0.0905 0.0108 0.075 0.0010... % Teff parameters
                 0.01 20 0.823 0.652 0.101 0.084 0.103 0.15...   % M parameters
                 0.091 10 0.74 0.05...      % EC parameters
                 9.025 55 0.362 0.108 0.117 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.243 0.08 0.182 9.05 0.0010 0.01 0.15 0.091 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[67.26 4.64 7.13 8.47 3.87 10.13];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		67.26 4.64 7.13 8.47 3.87 10.13
        %18.39 6.84 16.77 15.87 2.71 39.42 
        12.33 0.86 24.45 1.46 0.92 38.77 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.243 0.08 0.182 9.05 0.0010 0.01 0.15 0.091 0.05 9.025 0.0001];
