% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT178.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_43';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p43';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.06 10 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.112...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.122...   % Treg parameters
                 0.06 65 0.823 0.703 0.057 0.561 0.109 0.087 0.101... % Teff parameters
                 6.01 15 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 2.091 10 0.90 0.05...      % EC parameters
                 9.085 40 0.362 0.108 0.101 0.0001]; % F parameters % These values may be updated during optimization  

% 0.06 0.112 0.08 0.122 0.06 0.101 6.01 0.0015 5.091 0.0005 9.085 0.0001
...
inputs.exps.exp_data{1}=[                              
		7.42 9.99 58.68 9.94 2.34 11.62
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.44 2.162 44.17 9.62 0.904 27.41 
		];
...
inputs.PEsol.global_theta_guess=[0.06 0.112 0.08 0.122 0.06 0.101 6.01 0.0015 5.091 0.0005 9.085 0.0001];
