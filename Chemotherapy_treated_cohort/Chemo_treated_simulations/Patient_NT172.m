% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT149.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_37';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p37';                      % To identify figures and reports for a given problem   
...
inputs.exps.exp_data{1}=[                              
		38.57 4.26 24.53 4.30 3.67 27.25
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.23 0.86 13.64 17.32 1.95 48.09 
		];
