% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT112.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_30';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p30';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.04 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.131 0.215...   % CC parameters
                 0.08 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.127 0.172...   % Treg parameters
                 7.55 60 0.823 0.703 0.057 0.561 0.109 0.124 0.0060... % Teff parameters
                 0.03 15 0.823 0.652 0.101 0.084 0.137 0.1505...   % M parameters
                 0.101 15 0.123 0.05...      % EC parameters
                 9.85 60 0.362 0.108 0.111 0.001]; % F parameters % These values may be updated during optimization  

% 0.04 0.195 0.08 0.172 7.55 0.0060 0.03 0.1505 0.091 0.005 9.85 0.001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[38.98 5.85 15.49 7.93 6.83 24.92];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		38.98 5.85 15.49 7.93 6.83 24.92
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.98 0.9 40.49 0.98 1.093 40.49 
		];
...
inputs.PEsol.global_theta_guess=[0.04 0.215 0.08 0.172 7.55 0.0060 0.03 0.1505 0.101 0.05 9.85 0.001];
