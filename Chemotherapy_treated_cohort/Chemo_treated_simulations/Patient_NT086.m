% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT086.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_24';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p24';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.04 25 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.134 0.145...   % CC parameters
                 0.101 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.132...   % Treg parameters
                 0.0155 60 0.823 0.703 0.057 0.561 0.109 0.116 0.160... % Teff parameters
                 1.01 50 0.823 0.652 0.101 0.084 0.128 0.1305...   % M parameters
                 1.091 8 0.115 0.05...      % EC parameters
                 1.85 90 0.362 0.108 0.087 0.01]; % F parameters % These values may be updated during optimization  

% 0.15 0.125 0.101 0.132 0.0155 0.160 1.010 0.1305 1.091 0.05 1.85 0.01
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[8.20 9.07 42.20 26.57 5.42 10.89];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		8.20 9.07 42.20 26.57 5.42 10.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.02 0.86 19.80 7.15 0.97 50.72 
		];
...
inputs.PEsol.global_theta_guess=[0.04 0.145 0.101 0.132 0.0155 0.160 1.010 0.1305 1.091 0.05 1.85 0.01];
