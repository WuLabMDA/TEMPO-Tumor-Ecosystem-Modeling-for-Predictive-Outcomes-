...
Patient_NT227   % Calls the script with the inputs: 
                           % Model
...
if isfield(results, 'sim') && isfield(results.sim, 'obs')
   ...
   csv_filename = fullfile('V:\dkmarri\Mathematical_Model\AMIGO2_R2019c\AMIGO2_R2019c\IMC_BC_Analysis\Chemotherapy', 'PCR_Patient_227_simulation_results.csv');
