% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT252.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_66';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p66';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.072 70 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.132 0.154...   % CC parameters
                 0.01 10 0.10 0.109 0.103 0.129 0.085 0.059 0.077 0.130 0.241...   % Treg parameters
                 4.1 25 0.108 0.12 0.18 0.0905 0.0108 0.103 0.005... % Teff parameters
                 0.02 15 0.323 0.152 0.101 0.084 0.136 0.215...   % M parameters
                 0.011 10 0.127 0.167...      % EC parameters
                 9.225 60 0.362 0.108 0.121 0.0001]; % F parameters % These values may be updated during optimization  

% 0.072 0.154 0.011 0.201 4.1 0.005 0.02 0.185 0.011 0.157 9.225 0.0001
...
inputs.exps.exp_data{1}=[                              
		58.98 3.54 12.48 7.64 3.15 16.91
        %18.39 6.84 16.77 15.87 2.71 39.42 
        8.93 1.06 18.506 0.8 0.91 45.35 
		];
...
inputs.PEsol.global_theta_guess=[0.072 0.154 0.011 0.201 4.1 0.005 0.02 0.215 0.011 0.167 9.225 0.0001];
