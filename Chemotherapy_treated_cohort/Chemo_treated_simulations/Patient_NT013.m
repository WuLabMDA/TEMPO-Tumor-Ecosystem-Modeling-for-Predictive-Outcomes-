% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT013.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_3';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p3';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.00915 85 0.34 0.6027 0.0273 0.117 0.35 0.129 0.571 0.134 0.823 0.130 0.122 0.198 0.27...   % CC parameters
                 0.055 10 0.625 1.04 0.097 0.078 0.115 0.016 0.110 0.11 0.09...   % Treg parameters
                 4.85 35 0.9100 0.986 0.751 0.4818 0.0108 0.19035 0.00105... % Teff parameters
                 5.10 50 0.65 1.244 0.08 0.06 0.179 0.0025...   % M parameters
                 0.105 10 0.2155 0.015...      % EC parameters
                 8.85 80 0.673 0.0571 0.20023 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		79.20 4.03 6.17 2.21 3.57 9.82 
        %1.06 9.03 48.02 23.48 4.85 13.56 
        6.00 1.90 15.46 28.70 0.86 33.17 
		];
...
inputs.PEsol.global_theta_guess=[0.00915 0.27 0.055 0.09 4.85 0.00105 5.10 0.0025 0.105 0.015 8.85 0.001];
