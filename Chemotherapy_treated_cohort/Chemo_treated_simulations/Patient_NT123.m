% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT123.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_33';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p33';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.011 80 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.2098...   % CC parameters
                 0.04 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.152...   % Treg parameters
                 0.05 30 0.823 0.703 0.057 0.561 0.109 0.087 0.121... % Teff parameters
                 0.08 10 0.823 0.652 0.101 0.084 0.108 0.115...   % M parameters
                 0.091 10 0.90 0.105...      % EC parameters
                 9.85 60 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 0.101 0.098 0.04 0.152 0.05 0.121 0.08 0.115 0.091 0.105 9.85 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[57.14 4.68 20.37 5.99 1.94 9.87];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		57.14 4.68 20.37 5.99 1.94 9.87
        %18.39 6.84 16.77 15.87 2.71 39.42 
        6.79 0.86 12.67 2.41 0.91 37.12 
		];
...
inputs.PEsol.global_theta_guess=[0.011 0.2098 0.04 0.152 0.05 0.121 0.08 0.115 0.091 0.105 9.85 0.0001];
