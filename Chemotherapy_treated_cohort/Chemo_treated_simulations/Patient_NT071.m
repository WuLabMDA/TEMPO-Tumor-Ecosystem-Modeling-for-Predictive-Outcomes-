`% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT071.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_17';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p17';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.15 95 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 0.117 0.15...   % CC parameters
                 1.65 10 0.699 0.749 0.103 0.729 0.085 0.059 0.077 0.125 0.05...   % Treg parameters
                 9.0155 25 4.823 5.703 0.057 1.561 0.109 0.119 0.00190... % Teff parameters
                 7.010 20 6.123 3.452 0.101 0.084 0.147 0.0025...   % M parameters
                 5.091 15 0.089 0.005...      % EC parameters
                 0.85 40 3.362 0.108 0.136 0.01]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		75.79 1.99 2.90 1.99 1.01 16.96
        %18.39 6.84 16.77 15.87 2.71 39.42 
        71.43 1.6 2.81 5.05 1.47 4.55 
		];
...
inputs.PEsol.global_theta_guess=[0.15 0.15 1.65 0.05 9.0155 0.00190 7.10 0.025 5.091 0.005 0.85 0.01];
