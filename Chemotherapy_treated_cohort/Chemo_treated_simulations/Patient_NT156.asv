% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT156.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_40';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p40';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.06 50 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.055 0.0012...   % CC parameters
                 0.08 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.114 0.152...   % Treg parameters
                 8.15 60 0.98 0.92 0.98 0.0905 0.0108 0.068 0.001... % Teff parameters
                 0.01 95 0.823 0.652 0.101 0.084 0.128 0.215...   % M parameters
                 5.091 10 0.57 0.0005...      % EC parameters
                 9.085 60 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 6.06 0.0012 0.08 0.152 8.15 0.001 0.01 0.215 5.091 0.0005 9.085 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[1.36 8.08 8.99 78.66 0.91 2.54];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		1.36 8.08 8.99 78.66 0.91 2.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
        13.32 0.86 15.73 5.64 1.95 30.09 
		];
...
inputs.PEsol.global_theta_guess=[6.06 0.0012 0.08 0.152 8.15 0.001 0.01 0.215 5.091 0.0005 9.085 0.0001];
