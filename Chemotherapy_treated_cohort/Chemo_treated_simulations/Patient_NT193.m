% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT193.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_50';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p50';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[7.12 45 0.714 0.832 0.067 0.32 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.110 0.0002...   % CC parameters
                 0.05 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.117 0.193...   % Treg parameters
                 0.015 50 0.128 0.22 0.148 0.0905 0.0108 0.069 0.185... % Teff parameters
                 0.04 15 0.823 0.652 0.101 0.084 0.124 0.154...   % M parameters
                 0.091 10 0.109 0.05...      % EC parameters
                 9.025 65 0.362 0.108 0.118 0.0001]; % F parameters % These values may be updated during optimization  

% 6.12 0.002 0.05 0.193 0.015 0.185 0.04 0.154 0.091 0.05 9.025 0.0001
...
inputs.exps.exp_data{1}=[                              
		25.92 7.33 31.84 6.75 3.69 24.44
        %18.39 6.84 16.77 15.87 2.71 39.42 
        27.59 0.86 23.10 4.52 0.699 30.14 
		];
...
inputs.PEsol.global_theta_guess=[6.12 0.002 0.05 0.193 0.015 0.185 0.04 0.154 0.091 0.05 9.025 0.0001];
