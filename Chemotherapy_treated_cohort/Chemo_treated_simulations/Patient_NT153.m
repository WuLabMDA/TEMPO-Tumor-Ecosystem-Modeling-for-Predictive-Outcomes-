% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT153.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_39';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p39';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 100 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.232...   % CC parameters
                 5.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.113 0.0012...   % Treg parameters
                 8.15 60 0.98 0.92 0.98 0.0905 0.0108 0.068 0.001... % Teff parameters
                 6.01 15 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 7.091 10 0.90 0.0005...      % EC parameters
                 9.085 50 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 0.01 0.232 5.08 0.0012 8.15 0.001 6.01 0.0015 7.091 0.0005 9.085 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[81.62 0.86 4.59 1.51 1.91 11.14];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		81.62 0.86 4.59 1.51 1.91 11.14
        %18.39 6.84 16.77 15.87 2.71 39.42 
        10.62 1.13 40.96 8.58 0.91 29.57 
		];
