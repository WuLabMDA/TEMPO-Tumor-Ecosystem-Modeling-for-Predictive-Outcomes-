...
inputs.pathd.results_folder='imc_bc_chemotherapy_27';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p27';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.07 75 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.057 0.135...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.049 0.142...   % Treg parameters
                 0.125 30 0.823 0.703 0.057 0.561 0.109 0.101 0.100... % Teff parameters
                 6.01 10 0.823 0.652 0.101 0.084 0.226 0.05...   % M parameters
                 4.091 10 0.069 0.005...      % EC parameters
                 7.85 50 0.362 0.108 0.071 0.001]; % F parameters % These values may be updated during optimization  

% 0.07 0.135 0.08 0.142 0.125 0.100 6.010 0.05 4.091 0.005 7.85 0.001
...
inputs.exps.exp_data{1}=[                              
		60.40 3.64 14.24 1.20 3.41 17.09
        %18.39 6.84 16.77 15.87 2.71 39.42 
        19.55 0.85 12.20 5.29 5.65 36.76 
		];
...
inputs.PEsol.global_theta_guess=[0.07 0.135 0.08 0.142 0.125 0.100 6.010 0.05 4.091 0.005 7.85 0.001];
