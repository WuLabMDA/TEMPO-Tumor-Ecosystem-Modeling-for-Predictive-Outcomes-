% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT113.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_31';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p31';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 95 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.245...   % CC parameters
                 0.04 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.152...   % Treg parameters
                 5.65 30 0.823 0.703 0.057 0.561 0.109 0.087 0.0021... % Teff parameters
                 6.01 20 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 0.091 10 0.90 0.105...      % EC parameters
                 9.85 70 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 0.01 0.245 0.04 0.152 5.65 0.0021 6.01 0.0015 0.091 0.105 9.85 0.0001
...
inputs.exps.exp_data{1}=[                              
		72.04 1.91 4.56 2.74 4.94 14.82
        %18.39 6.84 16.77 15.87 2.71 39.42 
        6.05 0.86 14.90 8.94 0.95 50.94 
		];
...
inputs.PEsol.global_theta_guess=[0.01 0.245 0.04 0.152 5.65 0.0021 6.01 0.0015 0.091 0.105 9.85 0.0001];
