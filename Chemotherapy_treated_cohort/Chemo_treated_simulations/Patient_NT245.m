% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT245.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_60';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p60';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.09 75 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.125 0.134 0.189...   % CC parameters
                 0.01 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.067 0.162...   % Treg parameters
                 7.1 20 0.98 0.92 0.98 0.0905 0.0108 0.060 0.002... % Teff parameters
                 0.03 10 0.823 0.652 0.101 0.084 0.096 0.125...   % M parameters
                 0.041 10 0.062 0.05...      % EC parameters
                 9.025 60 0.362 0.108 0.111 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.189 0.01 0.162 7.1 0.002 0.03 0.125 0.041 0.05 9.025 0.0001
...
inputs.exps.exp_data{1}=[                              
		62.97 2.76 8.69 5.69 2.65 18.94
        %18.39 6.84 16.77 15.87 2.71 39.42 
        15.52 0.86 14.15 1.21 0.91 47.85 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.189 0.01 0.162 7.1 0.002 0.03 0.125 0.041 0.05 9.025 0.0001];
