% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT227.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_56';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p56';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.915 40 0.68 0.52 0.082 0.145 0.52 0.156 0.245 0.148 0.095 0.138 0.142 0.126 0.001...   % CC parameters
                 0.01 20 0.699 0.749 0.103 0.129 0.085 0.059 0.087 0.103 0.202...   % Treg parameters
                 0.08 60 0.98 0.92 0.98 0.0905 0.0108 0.066 0.195... % Teff parameters
                 0.03 45 0.823 0.652 0.101 0.084 0.059 0.165...   % M parameters
                 0.041 10 0.111 0.05...      % EC parameters
                 9.025 50 0.362 0.108 0.133 0.0001]; % F parameters % These values may be updated during optimization  

% 6.916 0.001 0.018 0.192 0.08 0.195 0.03 0.165 0.041 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[1.60 12.63 43.73 31.97 2.52 7.55];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		1.60 12.63 43.73 31.97 2.52 7.55
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.08 4.06 31.36 3.72 0.99 35.06 
		];
...
inputs.PEsol.global_theta_guess=[6.916 0.001 0.018 0.192 0.08 0.195 0.03 0.165 0.041 0.05 9.025 0.0001];
