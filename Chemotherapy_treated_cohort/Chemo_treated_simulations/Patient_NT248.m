% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT248.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_63';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p63';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.09 65 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.121 0.146...   % CC parameters
                 1.18 10 0.699 0.749 0.103 0.109 0.085 0.059 0.077 0.092 0.02...   % Treg parameters
                 0.01 40 0.28 0.12 0.18 0.0905 0.0108 0.111 0.195... % Teff parameters
                 8.03 35 0.823 0.652 0.101 0.084 0.099 0.003...   % M parameters
                 8.941 10 0.083 0.00005...      % EC parameters
                 9.925 40 0.362 0.108 0.094 0.00001]; % F parameters % These values may be updated during optimization  

% 0.09 0.146 5.18 0.02 0.1 0.195 8.03 0.003 8.941 0.00005 9.925 0.00001
...
inputs.exps.exp_data{1}=[                              
		52.66 0.88 27.96 4.74 2.07 14.65
        %18.39 6.84 16.77 15.87 2.71 39.42 
        31.65 1.0 14.72 23.88 0.91 17.05 
		];
...
inputs.PEsol.global_theta_guess=[0.09 0.146 1.18 0.02 0.1 0.195 8.03 0.003 8.941 0.00005 9.925 0.00001];
