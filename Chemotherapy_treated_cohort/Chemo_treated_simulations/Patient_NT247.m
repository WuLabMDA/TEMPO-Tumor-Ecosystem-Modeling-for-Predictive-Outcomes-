% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT247.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_62';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p62';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 25 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.077 0.243...   % CC parameters
                 0.018 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.046 0.192...   % Treg parameters
                 0.01 20 0.18 0.22 0.18 0.0905 0.0108 0.052 0.231... % Teff parameters
                 6.03 20 0.823 0.652 0.101 0.084 0.051 0.002...   % M parameters
                 0.031 10 0.076 0.05...      % EC parameters
                 9.025 100 0.362 0.108 0.074 0.0001]; % F parameters % These values may be updated during optimization  

% 0.01 0.243 0.018 0.192 0.01 0.231 6.03 0.002 0.031 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[15.05 1.81 11.03 3.20 5.22 65.70];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		15.05 1.81 11.03 3.20 5.22 65.70
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.08 0.86 15.65 1.23 1.02 42.10 
		];
...
inputs.PEsol.global_theta_guess=[0.010 0.213 0.018 0.192 0.07 0.165 6.03 0.002 0.031 0.05 9.025 0.0001];
