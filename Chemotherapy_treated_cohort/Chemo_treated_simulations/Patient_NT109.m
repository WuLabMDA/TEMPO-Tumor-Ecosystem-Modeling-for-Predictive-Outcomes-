% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT109.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_29';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p29';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.04 60 0.494 0.582 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.099 0.001...   % CC parameters
                 0.001 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.116 0.192...   % Treg parameters
                 0.0155 80 0.823 0.703 0.057 0.561 0.109 0.118 0.140... % Teff parameters
                 7.401 30 0.823 0.652 0.101 0.084 0.095 0.005...   % M parameters
                 9.091 15 0.072 0.005...      % EC parameters
                 9.85 55 0.362 0.108 0.120 0.001]; % F parameters % These values may be updated during optimization  

% 3.04 0.0014 0.001 0.192 0.0155 0.140 7.401 0.005 6.091 0.005 9.85 0.001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[15.46 7.52 59.24 2.88 1.39 13.51];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		15.46 7.52 59.24 2.88 1.39 13.51
        %18.39 6.84 16.77 15.87 2.71 39.42 
        10.06 0.86 33.28 15.35 7.987 33.28 
		];
...
inputs.PEsol.global_theta_guess=[9.04 0.001 0.001 0.192 0.0155 0.140 7.401 0.005 9.091 0.005 9.85 0.001];
