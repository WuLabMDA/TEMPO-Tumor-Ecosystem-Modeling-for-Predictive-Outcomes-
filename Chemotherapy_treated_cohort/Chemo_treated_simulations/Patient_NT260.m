% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT260.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_68';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p68';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 30 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.112 0.243...   % CC parameters
                 6.18 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.07 0.002...   % Treg parameters
                 8.1 40 0.98 0.92 0.98 0.0905 0.0108 0.093 0.001... % Teff parameters
                 9.03 20 0.823 0.652 0.101 0.084 0.096 0.001...   % M parameters
                 8.041 10 0.108 0.0005...      % EC parameters
                 9.025 55 0.362 0.108 0.125 0.0001]; % F parameters % These values may be updated during optimization  

% 0.01 0.243 6.18 0.002 8.1 0.001 9.03 0.001 8.041 0.0005 9.025 0.0001
...
inputs.exps.exp_data{1}=[                              
		44.24 1.59 10.14 6.63 2.28 37.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.02 0.86 41.49 11.37 6.06 39.35 
		];
...
inputs.PEsol.global_theta_guess=[0.01 0.243 6.18 0.002 8.1 0.001 9.03 0.001 8.041 0.0005 9.025 0.0001];
