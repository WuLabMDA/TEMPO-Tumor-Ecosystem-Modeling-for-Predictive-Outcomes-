% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT138.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_36';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p36';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[3.06 60 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.129 0.0012...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.102...   % Treg parameters
                 7.105 25 0.823 0.703 0.057 0.561 0.109 0.096 0.0011... % Teff parameters
                 0.03 25 0.823 0.652 0.101 0.084 0.108 0.115...   % M parameters
                 0.041 25 0.90 0.105...      % EC parameters
                 8.085 65 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 3.06 0.0012 0.08 0.102 7.105 0.0011 0.03 0.115 0.041 0.105 8.085 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[39.11 3.02 6.28 10.16 9.78 32.36];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		39.11 3.02 6.28 10.16 9.78 32.36
        %18.39 6.84 16.77 15.87 2.71 39.42 
        40.74 0.86 12.31 3.89 0.95 42.81 
		];
...
inputs.PEsol.global_theta_guess=[3.06 0.0012 0.08 0.102 7.105 0.0011 0.03 0.115 0.041 0.105 8.085 0.0001];
