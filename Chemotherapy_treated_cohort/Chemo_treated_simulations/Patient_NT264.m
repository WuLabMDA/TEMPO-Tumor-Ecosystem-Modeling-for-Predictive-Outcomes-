% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT264.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_71';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p71';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.09 65 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.117 0.178...   % CC parameters
                 0.02 10 0.109 0.149 0.103 0.129 0.085 0.059 0.077 0.104 0.210...   % Treg parameters
                 5.1 30 0.98 0.92 0.98 0.0905 0.0108 0.120 0.005... % Teff parameters
                 0.05 10 0.123 0.102 0.101 0.084 0.106 0.182...   % M parameters
                 0.01 10 0.088 0.194...      % EC parameters
                 9.025 55 0.362 0.108 0.111 0.0001]; % F parameters % These values may be updated during optimization  

% 0.03 0.203 0.02 0.162 5.1 0.005 5.03 0.002 8.041 0.0005 0.025 0.15
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[54.60 3.29 14.96 2.48 2.62 20.04];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		54.60 3.29 14.96 2.48 2.62 20.04
        %18.39 6.84 16.77 15.87 2.71 39.42 
        20.24 0.86 19.98 0.68 0.91 41.28 
		];
...
inputs.PEsol.global_theta_guess=[ 0.03 0.203 0.02 0.162 5.1 0.005 0.09 0.142 8.041 0.0005 9.025 0.0001];
