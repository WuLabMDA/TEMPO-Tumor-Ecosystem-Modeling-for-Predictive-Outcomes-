% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT188.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_46';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p46';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 65 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.122 0.243...   % CC parameters
                 0.006 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.119 0.192...   % Treg parameters
                 0.0015 30 0.248 0.232 0.48 0.0905 0.0108 0.147 0.165... % Teff parameters
                 6.01 35 0.823 0.652 0.101 0.084 0.133 0.00015...   % M parameters
                 0.021 20 0.120 0.105...      % EC parameters
                 9.025 70 0.362 0.108 0.124 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.243 0.06 0.182 0.015 0.00105 6.01 0.00015 0.021 0.105 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[43.84 4.09 19.42 5.77 10.80 20.08];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		43.84 4.09 19.42 5.77 10.80 20.08
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.61 4.176 13.74 14.90 0.96 40.614 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.243 0.06 0.182 0.0015 0.105 6.01 0.00015 0.021 0.105 9.025 0.0001];
