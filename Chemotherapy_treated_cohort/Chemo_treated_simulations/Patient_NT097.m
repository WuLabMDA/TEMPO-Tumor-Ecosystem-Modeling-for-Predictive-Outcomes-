% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT097.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_26';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p26';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.07 10 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.129 0.135...   % CC parameters
                 0.05 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.102 0.172...   % Treg parameters
                 0.015 60 0.823 0.703 0.057 0.561 0.109 0.098 0.150... % Teff parameters
                 0.101 50 0.823 0.652 0.101 0.084 0.111 0.105...   % M parameters
                 4.091 10 0.102 0.005...      % EC parameters
                 8.85 90 0.362 0.108 0.137 0.001]; % F parameters % These values may be updated during optimization  

% 0.07 0.135 0.1 0.142 0.155 0.110 0.101 0.105 4.091 0.005 8.85 0.001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[67.92 4.87 6.92 11.19 1.085 9.34];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		67.92 4.87 6.92 11.19 1.085 9.34
        %18.39 6.84 16.77 15.87 2.71 39.42 
        16.33 0.86 5.51 0.59 4.307 40.72 
		];
...
inputs.PEsol.global_theta_guess=[0.07 0.135 0.05 0.172 0.015 0.150 0.101 0.105 4.091 0.005 8.85 0.001];
