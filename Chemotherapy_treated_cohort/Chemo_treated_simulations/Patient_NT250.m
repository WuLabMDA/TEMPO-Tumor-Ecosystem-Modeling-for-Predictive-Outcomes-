% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT250.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_64';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p64';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.015 80 0.11 0.18 0.05 0.11 0.5076 0.131 0.261 0.128 0.109 0.128 0.125 0.133 0.213...   % CC parameters
                 0.01 10 0.307 0.428 0.102 0.113 0.09 0.387 0.092 0.114 0.195...   % Treg parameters
                 0.015 10 0.124 0.106 0.183 0.343 0.1108 0.063 0.189... % Teff parameters
                 0.010 10 0.16 0.468 0.091 0.0851 0.130 0.205...   % M parameters
                 0.0091 15 0.126 0.15...      % EC parameters
                 9.05 60 1.973 0.0571 0.123 0.0001]; % F parameters % These values may be updated during optimization  
% 0.015 0.213 0.01 0.195 0.015 0.189 0.01 0.205 0.0091 0.15 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[69.77 2.82 7.80 5.84 2.13 12.22];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		69.77 2.82 7.80 5.84 2.13 12.22
        %18.39 6.84 16.77 15.87 2.71 39.42 
        11.38 0.86 3.506 1.21 0.91 35.23 
		];
...
inputs.PEsol.global_theta_guess=[0.015 0.213 0.01 0.195 0.015 0.189 0.01 0.205 0.0091 0.15 9.025 0.0001];
