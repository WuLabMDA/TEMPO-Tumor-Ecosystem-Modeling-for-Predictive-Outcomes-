...
function consolidatedData = consolidateRDFiles(folderPath)
    ...
    filePattern = fullfile(folderPath, 'RD_Patient*.csv');
    ...
    for i = 1:length(files)
        ...
        try
            ...
            patientID = extractBetween(files(i).name, 'RD_Patient_', '_simulation');
    ...
    outputFile = fullfile(folderPath, 'Chemotherapy_Consolidated_RD_Data.csv');
