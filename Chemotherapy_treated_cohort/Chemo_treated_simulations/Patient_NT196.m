% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT196.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_51';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p51';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 80 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.117 0.213...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.075 0.102...   % Treg parameters
                 0.15 30 0.98 0.92 0.98 0.0905 0.0108 0.081 0.11... % Teff parameters
                 0.01 10 0.823 0.652 0.101 0.084 0.135 0.1105...   % M parameters
                 0.091 10 0.104 0.05...      % EC parameters
                 0.025 30 0.362 0.108 0.098 0.01]; % F parameters % These values may be updated during optimization  

% 0.01 0.213 0.08 0.102 0.15 0.11 0.01 0.105 0.091 0.05 0.025 0.01
...
inputs.exps.exp_data{1}=[                              
		62.26 5.27 12.35 3.31 5.04 14.76
        %18.39 6.84 16.77 15.87 2.71 39.42 
        40.50 0.95 1.90 1.24 0.91 3.28 
		];
...
inputs.PEsol.global_theta_guess=[0.01 0.146 0.08 0.102 0.15 0.11 0.01 0.105 0.091 0.05 0.025 0.01];
