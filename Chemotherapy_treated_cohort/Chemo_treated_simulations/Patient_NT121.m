% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT121.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_32';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p32';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[7.56 85 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.064 0.001...   % CC parameters
                 0.103 20 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.089 0.142...   % Treg parameters
                 0.01 65 0.823 0.703 0.057 0.561 0.109 0.116 0.162... % Teff parameters
                 6.01 15 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 9.091 10 0.075 0.0005...      % EC parameters
                 9.85 30 0.062 0.108 0.067 0.0001]; % F parameters % These values may be updated during optimization  

% 6.56 0.005 0.03 0.162 0.015 0.152 6.01 0.0015 5.091 0.0005 9.85 0.0001
...
inputs.exps.exp_data{1}=[                              
		34.31 10.21 37.09 3.95 2.24 12.15
        %18.39 6.84 16.77 15.87 2.71 39.42 
        60.25 1.97 8.28 0.95 1.97 9.25 
		];
...
inputs.PEsol.global_theta_guess=[7.56 0.001 0.103 0.142 0.01 0.162 6.01 0.0015 5.091 0.0005 9.85 0.0001];
