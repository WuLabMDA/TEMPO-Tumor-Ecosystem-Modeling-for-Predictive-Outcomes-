% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT084.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_23';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p23';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 90 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.128 0.185...   % CC parameters
                 0.06 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.068 0.1205...   % Treg parameters
                 0.0155 17 0.823 0.703 0.057 0.561 0.109 0.089 0.160... % Teff parameters
                 1.01 35 0.823 0.652 0.101 0.084 0.113 0.1305...   % M parameters
                 1.091 15 0.091 0.05...      % EC parameters
                 8.85 90 0.362 0.108 0.129 0.001]; % F parameters % These values may be updated during optimization  


% 0.05 0.185 0.06 0.1205 0.0155 0.160 1.010 0.1305 1.091 0.05 8.85 0.001
%==================================
...
inputs.exps.exp_data{1}=[                              
		32.87 2.24 32.77 18.84 2.51 10.82
        %18.39 6.84 16.77 15.87 2.71 39.42 
        2.45 0.86 9.97 2.29 1.11 55.12 
		];
...
inputs.PEsol.global_theta_guess=[0.05 0.185 0.06 0.1205 0.0155 0.160 1.010 0.1305 1.091 0.05 8.85 0.001];
