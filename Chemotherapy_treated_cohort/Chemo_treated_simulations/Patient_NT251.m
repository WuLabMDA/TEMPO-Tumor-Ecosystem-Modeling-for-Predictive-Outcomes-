% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT251.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_65';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p65';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.021 15 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.127 0.223...   % CC parameters
                 0.01 20 0.099 0.149 0.103 0.129 0.085 0.059 0.077 0.06 0.192...   % Treg parameters
                 0.07 60 0.28 0.102 0.108 0.0905 0.0108 0.114 0.195... % Teff parameters
                 8.03 30 0.823 0.652 0.101 0.084 0.066 0.0010...   % M parameters
                 0.01 10 0.111 0.05...      % EC parameters
                 9.625 55 0.362 0.108 0.125 0.0001]; % F parameters % These values may be updated during optimization  

% 0.021 0.223 0.01 0.192 0.07 0.195 8.03 0.001 0.01 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[6.44 11.69 47.83 4.62 6.78 22.63];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		6.44 11.69 47.83 4.62 6.78 22.63
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.75 0.86 36.50 19.23 0.91 30.91 
		];
...
inputs.PEsol.global_theta_guess=[0.021 0.223 0.01 0.192 0.07 0.195 8.03 0.001 0.01 0.05 9.025 0.0001
];
