% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT042.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_11';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p11';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.12 50 0.105 0.129 0.068 0.116 0.645 0.113 0.221 0.128 0.075 0.118 0.111 0.107 0.205...   % CC parameters
                 0.255 15 0.345 0.442 0.111 0.089 0.105 0.323 0.106 0.101 0.135...   % Treg parameters
                 0.015 50 0.123 0.079 0.283 0.481 0.09 0.108 0.120... % Teff parameters
                 0.10 50 0.101 0.173 0.110 0.064 0.123 0.125...   % M parameters
                 0.101 15 0.105 0.105...      % EC parameters
                 9.85 65 0.101 0.179 0.112 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		30.96 6.00 36.58 33.76 2.56 18.14 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        4.09 1.05 23.42 3.22 0.59 23.06 
		];
...
inputs.PEsol.global_theta_guess=[0.12 0.205 0.255 0.135 0.015 0.120 0.10 0.125 0.101 0.105 9.85 0.001];
