% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT246.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_61';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p61';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.09 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.130 0.155...   % CC parameters
                 0.018 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.140 0.213...   % Treg parameters
                 0.01 35 0.98 0.92 0.98 0.0905 0.0108 0.110 0.215... % Teff parameters
                 0.09 15 0.823 0.652 0.101 0.084 0.127 0.105...   % M parameters
                 0.01 10 0.108 0.05...      % EC parameters
                 9.025 65 0.362 0.108 0.125 0.0001]; % F parameters % These values may be updated during optimization  

% 0.09 0.155 0.018 0.192 0.01 0.215 0.09 0.105 0.01 0.05 9.025 0.0001
...
inputs.exps.exp_data{1}=[                              
		40.54 4.60 23.41 6.54 5.00 19.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
        11.64 1.86 3.7 1.41 1.34 40.35 
		];
...
inputs.PEsol.global_theta_guess=[0.09 0.155 0.018 0.213 0.01 0.215 0.09 0.105 0.01 0.05 9.025 0.0001];
