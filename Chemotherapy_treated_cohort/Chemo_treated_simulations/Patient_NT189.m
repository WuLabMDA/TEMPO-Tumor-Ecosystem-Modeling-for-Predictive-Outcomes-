% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT189.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_47';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p47';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.012 80 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.129 0.002...   % CC parameters
                 0.08 20 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.110 0.182...   % Treg parameters
                 0.015 25 0.98 0.92 0.98 0.0905 0.0108 0.099 0.135... % Teff parameters
                 0.01 25 0.823 0.652 0.101 0.084 0.126 0.154...   % M parameters
                 0.091 10 0.120 0.05...      % EC parameters
                 9.025 50 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 6.012 0.002 0.08 0.182 0.015 0.135 0.01 0.154 0.091 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[52.12 10.89 15.53 13.86 3.39 6.25];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		52.12 10.89 15.53 13.86 3.39 6.25
        %18.39 6.84 16.77 15.87 2.71 39.42 
        60.42 1.126 1.80 2.32 0.95 1.027 
		];
...
inputs.PEsol.global_theta_guess=[6.012 0.002 0.08 0.182 0.015 0.135 0.01 0.154 0.091 0.05 9.025 0.0001];
