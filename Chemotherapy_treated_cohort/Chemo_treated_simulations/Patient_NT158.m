% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT158.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_41';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p41';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.02 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.212...   % CC parameters
                 0.08 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.182...   % Treg parameters
                 0.05 40 0.823 0.703 0.057 0.561 0.109 0.087 0.171... % Teff parameters
                 0.03 25 0.823 0.652 0.101 0.084 0.108 0.15...   % M parameters
                 0.091 10 0.90 0.12...      % EC parameters
                 9.085 65 0.362 0.108 0.108 0.0001]; % F parameters % These values may be updated during optimization  

% 0.02 0.212 0.08 0.182 0.05 0.171 0.03 0.15 5.091 0.0012 9.085 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[38.60 6.57 20.87 11.54 2.04 21.32];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		38.60 6.57 20.87 11.54 2.04 21.32
        %18.39 6.84 16.77 15.87 2.71 39.42 
        5.23 0.86 9.59 3.89 0.95 45.65 
		];
...
inputs.PEsol.global_theta_guess=[0.02 0.212 0.08 0.182 0.05 0.171 0.03 0.15 5.091 0.0012 9.085 0.0001];
