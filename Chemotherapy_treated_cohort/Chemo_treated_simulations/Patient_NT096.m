% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT096.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_25';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p25';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.54 10 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.134 0.105...   % CC parameters
                 0.09 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.152...   % Treg parameters
                 0.155 60 0.823 0.703 0.057 0.561 0.109 0.116 0.098... % Teff parameters
                 6.01 50 0.823 0.652 0.101 0.084 0.128 0.005...   % M parameters
                 0.051 10 0.115 0.165...      % EC parameters
                 7.85 90 0.362 0.108 0.087 0.001]; % F parameters % These values may be updated during optimization  

% 0.54 0.105 0.09 0.152 0.155 0.098 6.010 0.005 0.091 0.105 7.85 0.001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[45.06 6.88 16.76 2.21 3.71 25.39];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		45.06 6.88 16.76 2.21 3.71 25.39
        %18.39 6.84 16.77 15.87 2.71 39.42 
        25.12 0.86 14.70 8.33 0.89 40.73 
		];
...
inputs.PEsol.global_theta_guess=[0.54 0.105 0.09 0.152 0.155 0.098 6.010 0.005 0.051 0.165 7.85 0.001];
