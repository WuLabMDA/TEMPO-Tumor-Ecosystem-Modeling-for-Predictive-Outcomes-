% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT062.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_14';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p14';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.1915 85 0.113 0.138 0.082 0.122 0.435 0.135 0.189 0.134 0.090 0.132 0.125 0.131 0.215...   % CC parameters
                 0.055 20 0.212 0.104 0.111 0.096 0.108 0.409 0.085 0.129 0.095...   % Treg parameters
                 1.155 15 0.127 0.1085 0.199 0.0215 0.009409 0.085 0.0120... % Teff parameters
                 1.010 15 0.123 0.452 0.101 0.084 0.147 0.025...   % M parameters
                 0.091 20 0.0104 0.105...      % EC parameters
                 9.85 75 0.362 0.108 0.136 0.0001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		65.11 2.01 1.027 0.87 11.41 19.31 
        %18.39 6.84 16.77 15.87 2.71 39.42 
        28.63 0.502 3.68 4.88 1.08 40.29 
		];
...
inputs.PEsol.global_theta_guess=[0.1915 0.215 0.055 0.095 1.955 0.0120 1.10 0.025 0.091 0.105 9.85 0.0001];
