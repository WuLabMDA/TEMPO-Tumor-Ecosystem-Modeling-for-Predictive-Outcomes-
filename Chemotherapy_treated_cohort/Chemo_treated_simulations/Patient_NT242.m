% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT242.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_59';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p59';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.01 45 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.133 0.213...   % CC parameters
                 0.02 25 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.117 0.201...   % Treg parameters
                 8.1 65 0.98 0.92 0.98 0.0905 0.0108 0.094 0.001... % Teff parameters
                 6.03 30 0.823 0.652 0.101 0.084 0.112 0.0002...   % M parameters
                 0.041 10 0.126 0.0005...      % EC parameters
                 9.025 30 0.362 0.108 0.131 0.0001]; % F parameters % These values may be updated during optimization  

% 0.01 0.213 0.02 0.201 8.1 0.001 6.03 0.0002 0.041 0.0005 9.025 0.0001
...
inputs.exps.exp_data{1}=[                              
		32.18 15.54 20.09 9.38 5.14 17.31
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.19 0.86 55.91 20.85 0.91 22.52 
		];
...
inputs.PEsol.global_theta_guess=[0.01 0.213 0.02 0.201 8.1 0.001 6.03 0.0002 0.041 0.0005 9.025 0.0001];
