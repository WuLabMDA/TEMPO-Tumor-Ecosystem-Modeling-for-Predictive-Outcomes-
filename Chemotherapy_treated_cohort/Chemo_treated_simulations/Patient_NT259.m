% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT259.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_67';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p67';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 60 0.614 0.932 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.121 0.198...   % CC parameters
                 0.01 10 0.109 0.114 0.103 0.129 0.085 0.059 0.077 0.103 0.232...   % Treg parameters
                 0.02 30 0.108 0.112 0.128 0.0905 0.0108 0.103 0.185... % Teff parameters
                 0.03 20 0.123 0.105 0.101 0.084 0.096 0.175...   % M parameters
                 0.021 10 0.113 0.163...      % EC parameters
                 9.025 50 0.362 0.108 0.115 0.0001]; % F parameters % These values may be updated during optimization  

% 3.05 0.0998 0.01 0.232 0.02 0.185 0.03 0.175 0.021 0.163 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[41.89 5.42 19.69 10.66 4.42 17.92];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		41.89 5.42 19.69 10.66 4.42 17.92
        %18.39 6.84 16.77 15.87 2.71 39.42 
        5.96 0.86 8.32 1.48 1.86 36.35 
		];
...
inputs.PEsol.global_theta_guess=[0.05 0.198 0.01 0.232 0.02 0.185 0.03 0.175 0.021 0.163 9.025 0.0001
];
