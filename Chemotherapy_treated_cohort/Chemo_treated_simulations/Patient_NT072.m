% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT072.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_18';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p18';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 40 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 0.117 0.215...   % CC parameters
                 0.105 15 0.699 0.749 0.103 0.729 0.085 0.059 0.077 0.125 0.1605...   % Treg parameters
                 9.0155 100 0.823 0.703 0.057 0.561 0.109 0.119 0.00190... % Teff parameters
                 0.010 55 0.123 0.452 0.101 0.084 0.147 0.105...   % M parameters
                 10.091 15 0.079 0.0005...      % EC parameters
                 3.85 20 0.362 0.108 0.136 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		22.11 7.36 46.09 21.36 0.87 2.21
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.02 1.07 80.30 7.71 1.21 3.41 
		];
...
inputs.PEsol.global_theta_guess=[0.05 0.215 0.105 0.1605 9.0155 0.00190 0.010 0.105 9.091 0.005 1.85 0.001];
