% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT228.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_57';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p57';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 40 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.125 0.213...   % CC parameters
                 0.02 25 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.112 0.202...   % Treg parameters
                 0.1 45 0.98 0.92 0.98 0.0905 0.0108 0.113 0.185... % Teff parameters
                 7.65 45 0.823 0.652 0.101 0.084 0.116 0.001...   % M parameters
                 0.041 10 0.115 0.05...      % EC parameters
                 9.025 55 0.362 0.108 0.118 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.213 0.020 0.202 0.1 0.185 7.65 0.001 0.041 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[27.46 13.79 33.58 9.08 4.23 11.86];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		27.46 13.79 33.58 9.08 4.23 11.86
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.023 0.86 16.49 32.41 0.91 40.02 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.213 0.020 0.202 0.1 0.185 7.65 0.001 0.041 0.05 9.025 0.0001];
