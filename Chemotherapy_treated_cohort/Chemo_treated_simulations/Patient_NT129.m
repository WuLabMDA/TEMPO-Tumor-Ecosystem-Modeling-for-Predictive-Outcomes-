% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT129.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_35';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p35';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.06 75 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.130 0.212...   % CC parameters
                 0.08 20 0.199 0.249 0.103 0.129 0.085 0.059 0.077 0.108 0.152...   % Treg parameters
                 0.09 30 0.823 0.703 0.057 0.561 0.109 0.119 0.121... % Teff parameters
                 6.01 30 0.823 0.652 0.101 0.084 0.138 0.0015...   % M parameters
                 0.091 5 0.129 0.115...      % EC parameters
                 3.085 65 0.362 0.108 0.123 0.0001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		52.02 3.49 16.13 5.57 4.51 20.29
        %18.39 6.84 16.77 15.87 2.71 39.42 
        7.29 0.86 13.03 12.74 0.95 45.28 
		];
...
inputs.PEsol.global_theta_guess=[0.06 0.212 0.08 0.152 0.09 0.121 6.01 0.0015 0.091 0.115 8.085 0.0001];
