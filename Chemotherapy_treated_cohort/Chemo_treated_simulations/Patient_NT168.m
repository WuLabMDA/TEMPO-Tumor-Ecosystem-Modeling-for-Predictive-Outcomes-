% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT168.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_42';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p42';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.02 70 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.262...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.182...   % Treg parameters
                 8.15 50 0.98 0.92 0.98 0.0905 0.0108 0.09035 0.00105... % Teff parameters
                 6.01 20 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 7.091 20 0.90 0.005...      % EC parameters
                 0.015 50 0.362 0.108 0.108 0.101]; % F parameters % These values may be updated during optimization  

% 0.02 0.2.62 0.08 0.182 8.15 0.00105 6.01 0.0015 7.091 0.005 0.015 0.101
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[49.79 3.01 8.92 3.14 6.11 29.03];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		49.79 3.01 8.92 3.14 6.11 29.03
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.23 1.186 59.15 8.98 9.97 11.16 
		];
...
inputs.PEsol.global_theta_guess=[0.02 0.262 0.08 0.182 8.15 0.00105 6.01 0.0015 7.091 0.005 0.015 0.101];
