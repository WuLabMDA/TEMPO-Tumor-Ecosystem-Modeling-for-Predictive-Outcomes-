% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT192.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_49';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p49';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 50 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.132 0.213...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.110 0.186...   % Treg parameters
                 0.015 45 0.128 0.22 0.218 0.0905 0.0108 0.106 0.145... % Teff parameters
                 7.01 30 0.823 0.652 0.101 0.084 0.131 0.00015...   % M parameters
                 0.091 10 0.107 0.05...      % EC parameters
                 9.025 60 0.362 0.108 0.128 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.213 0.08 0.186 0.015 0.145 7.01 0.00015 0.091 0.05 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[35.39 4.38 27.59 8.03 3.87 20.75];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		35.39 4.38 27.59 8.03 3.87 20.75
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.25 0.86 8.00 9.25 1.02 30.25 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.213 0.08 0.186 0.015 0.145 7.01 0.00015 0.091 0.05 9.025 0.0001];
