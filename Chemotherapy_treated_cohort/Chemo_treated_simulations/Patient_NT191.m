% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT191.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_48';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p48';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.062 95 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.107 0.123...   % CC parameters
                 5.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.104 0.0012...   % Treg parameters
                 7.15 25 0.98 0.92 0.98 0.0905 0.0108 0.0995 0.0015... % Teff parameters
                 6.01 15 0.823 0.652 0.101 0.084 0.116 0.000105...   % M parameters
                 8.091 10 0.059 0.0005...      % EC parameters
                 9.025 60 0.362 0.108 0.085 0.0001]; % F parameters % These values may be updated during optimization  

% 0.062 0.123 5.08 0.0012 7.15 0.0015 6.01 0.000105 8.091 0.0005 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[78.48 0.86 3.49 0.83 1.35 15.43];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		78.48 0.86 3.49 0.83 1.35 15.43
        %18.39 6.84 16.77 15.87 2.71 39.42 
        33.86 1.1 15.07 7.42 2.06 30.40 
		];
...
inputs.PEsol.global_theta_guess=[0.062 0.123 5.08 0.0012 7.15 0.0015 6.01 0.000105 8.091 0.0005 9.025 0.0001];
