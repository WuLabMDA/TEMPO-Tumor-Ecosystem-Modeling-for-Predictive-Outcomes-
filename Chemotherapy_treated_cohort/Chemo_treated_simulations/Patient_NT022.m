% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT022.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_4';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p4';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.0915 65 0.11 0.18 0.05 0.11 0.5076 0.131 0.261 0.128 0.109 0.128 0.125 0.133 0.15...   % CC parameters
                 1.055 10 0.307 0.428 0.102 0.113 0.09 0.387 0.092 0.014 0.105...   % Treg parameters
                 6.15 20 0.124 0.106 0.183 0.343 0.1108 0.063 0.009... % Teff parameters
                 1.10 20 0.16 0.468 0.091 0.0851 0.130 0.0025...   % M parameters
                 0.51091 15 0.126 0.15...      % EC parameters
                 6.85 80 1.973 0.0571 0.123 0.001]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[45.30 7.46 8.18 13.17 7.26 16.63 ];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		45.30 7.46 8.18 13.17 7.26 16.63 
        %1.06 9.03 48.02 23.48 4.85 13.56 
        6.58 0.505 11.58 0.61 0.806 30.81 
		];
...
inputs.PEsol.global_theta_guess=[0.0915 0.15 1.055 0.105 6.15 0.009 1.10 0.0025 0.51091 0.15 6.85 0.001];
...
inputs.nlpsol.eSS.maxeval = 300000;
