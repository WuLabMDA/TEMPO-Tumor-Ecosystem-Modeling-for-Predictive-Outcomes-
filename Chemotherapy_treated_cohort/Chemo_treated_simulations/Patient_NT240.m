% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT240.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_58';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p58';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 65 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.130 0.220...   % CC parameters
                 0.018 15 0.699 0.749 0.103 0.159 0.085 0.059 0.077 0.104 0.147...   % Treg parameters
                 9.1 60 0.98 0.92 0.98 0.0905 0.0108 0.097 0.001... % Teff parameters
                 7.03 30 0.823 0.652 0.101 0.084 0.099 0.002...   % M parameters
                 9.041 50 0.101 0.0005...      % EC parameters
                 9.025 20 0.362 0.108 0.118 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.220 8.18 0.0002 9.1 0.001 8.03 0.002 6.041 0.0005 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[51.24 4.33 24.19 6.95 1.24 12.05];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		51.24 4.33 24.19 6.95 1.24 12.05
        %18.39 6.84 16.77 15.87 2.71 39.42 
        2.70 1.05 48.79 21.73 2.71 9.18 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.220 0.018 0.147 9.1 0.001 7.03 0.002 6.041 0.0005 9.025 0.0001];
