% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT200.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_54';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p54';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.012 70 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.138 0.243...   % CC parameters
                 0.18 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.133 0.132...   % Treg parameters
                 0.15 25 0.98 0.92 0.98 0.0905 0.0108 0.125 0.125... % Teff parameters
                 0.01 10 0.823 0.652 0.101 0.084 0.136 0.15...   % M parameters
                 8.091 10 0.112 0.0005...      % EC parameters
                 9.025 60 0.362 0.108 0.117 0.0001]; % F parameters % These values may be updated during optimization  

% 0.012 0.243 0.18 0.132 0.15 0.125 0.01 0.15 8.091 0.0005 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[52.07 1.26 12.25 2.83 1.04 32.98];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		52.07 1.26 12.25 2.83 1.04 32.98
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.123 0.86 10.84 0.6 4.12 45.26 
		];
...
inputs.PEsol.global_theta_guess=[0.012 0.243 0.18 0.132 0.15 0.125 0.01 0.15 8.091 0.0005 9.025 0.0001];
