% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT263.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_70';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p70';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.05 70 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.079 0.143...   % CC parameters
                 0.02 10 0.109 0.149 0.103 0.129 0.085 0.059 0.077 0.112 0.192...   % Treg parameters
                 6.1 30 0.98 0.92 0.98 0.0905 0.0108 0.095 0.005... % Teff parameters
                 0.03 10 0.123 0.102 0.101 0.084 0.106 0.172...   % M parameters
                 0.041 10 0.112 0.163...      % EC parameters
                 9.025 55 0.362 0.108 0.122 0.0001]; % F parameters % These values may be updated during optimization  

% 0.05 0.163 0.02 0.192 6.1 0.005 0.03 0.172 0.041 0.163 9.025 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[56.14 4.25 13.86 3.86 2.45 19.44];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		56.14 4.25 13.86 3.86 2.45 19.44
        %18.39 6.84 16.77 15.87 2.71 39.42 
        15.52 0.86 18.95 0.58 3.91 44.99 
		];
...
inputs.PEsol.global_theta_guess=[ 0.05 0.143 0.02 0.192 6.1 0.005 0.03 0.172 0.041 0.163 9.025 0.0001 ];
