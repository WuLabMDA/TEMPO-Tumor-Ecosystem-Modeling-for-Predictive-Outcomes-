% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT081.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_22';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p22';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.07 65 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.133 0.201...   % CC parameters
                 0.108 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.098 0.1405...   % Treg parameters
                 8.155 30 0.823 0.703 0.057 0.561 0.109 0.099 0.007... % Teff parameters
                 9.610 50 0.823 0.652 0.101 0.084 0.0967 0.005...   % M parameters
                 1.091 15 0.131 0.095...      % EC parameters
                 0.85 65 0.362 0.108 0.126 0.001]; % F parameters % These values may be updated during optimization  

% 0.07 0.201 0.108 0.1405 6.155 0.0710 9.610 0.005 1.091 0.095 0.85 0.001
%==================================
% EXPERIMENTAL SCHEME RELATED DATA
%==================================
 inputs.exps.n_exp=1;                                  %Number of experiments                                                                            
 for iexp=1:inputs.exps.n_exp   
 inputs.exps.exp_y0{iexp}=[39.41 2.55 5.66 1.74 7.54 45.219];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		39.41 2.55 5.66 1.74 7.54 45.21
        %18.39 6.84 16.77 15.87 2.71 39.42 
        1.05 0.87 15.97 31.41 2.18 30.52 
		];
...
inputs.PEsol.global_theta_guess=[0.07 0.201 0.108 0.1405 8.155 0.007 9.610 0.005 1.091 0.095 0.85 0.001];
