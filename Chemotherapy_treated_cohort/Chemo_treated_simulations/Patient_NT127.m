...
inputs.pathd.results_folder='imc_bc_chemotherapy_34';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p34';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.06 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.101 0.0012...   % CC parameters
                 0.08 20 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.123 0.102...   % Treg parameters
                 0.05 50 0.823 0.703 0.057 0.561 0.109 0.087 0.121... % Teff parameters
                 6.01 50 0.823 0.652 0.101 0.084 0.108 0.0015...   % M parameters
                 0.091 20 0.90 0.105...      % EC parameters
                 0.085 30 0.362 0.108 0.108 0.01]; % F parameters % These values may be updated during optimization  

% 6.06 0.0012 0.08 0.102 0.05 0.121 6.01 0.0015 0.091 0.105 0.085 0.01
...
inputs.exps.exp_data{1}=[                              
		17.36 10.26 27.96 17.81 10.03 16.54
        %18.39 6.84 16.77 15.87 2.71 39.42 
        35.23 0.86 1.03 22.11 0.95 1.09 
		];
...
inputs.PEsol.global_theta_guess=[6.06 0.0012 0.08 0.102 0.05 0.121 6.01 0.0015 0.091 0.105 0.085 0.01];
