...
% Script to run parameter estimation and simulation for IMC Breast Cancer Model

% Clear previous results and add paths
clc;
clear all;
close all;
rng('default');
...
if isfield(results, 'sim') && isfield(results.sim, 'obs')
   ...
   csv_filename = fullfile('V:\dkmarri\Mathematical_Model\AMIGO2_R2019c\AMIGO2_R2019c\IMC_BC_Analysis\Chemotherapy', 'PCR_Patient_009_simulation_results.csv');
