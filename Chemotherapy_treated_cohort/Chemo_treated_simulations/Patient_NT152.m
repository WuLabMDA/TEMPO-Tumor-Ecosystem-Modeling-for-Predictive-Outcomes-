% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT152.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_38';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p38';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.03 75 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 0.124 0.202...   % CC parameters
                 0.08 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 0.120 0.102...   % Treg parameters
                 8.15 65 0.98 0.92 0.98 0.0905 0.0108 0.068 0.001... % Teff parameters
                 0.09 20 0.823 0.652 0.101 0.084 0.121 0.0015...   % M parameters
                 0.091 15 0.11 0.105...      % EC parameters
                 9.085 65 0.362 0.108 0.093 0.0001]; % F parameters % These values may be updated during optimization  

% 0.03 0.202 0.08 0.102 8.15 0.001 0.09 0.0015 0.091 0.105 9.085 0.0001
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[55.66 4.52 7.56 8.18 4.09 19.98];  %Initial conditions for each experiment          
...
inputs.exps.exp_data{1}=[                              
		55.66 4.52 7.56 8.18 4.09 19.98
        %18.39 6.84 16.77 15.87 2.71 39.42 
        3.11 1.86 42.07 4.46 1.75 47.99 
		];
...
inputs.PEsol.global_theta_guess=[0.03 0.202 0.08 0.102 8.15 0.001 0.09 0.0015 0.091 0.105 9.085 0.0001];
