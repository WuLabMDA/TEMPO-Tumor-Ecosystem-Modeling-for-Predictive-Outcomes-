% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Chemotherapy/Chemo_Patient_NT075.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='imc_bc_chemotherapy_20';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='imc_chemo_p20';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[0.15 90 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 0.117 0.185...   % CC parameters
                 0.05 15 0.699 0.749 0.103 0.729 0.085 0.059 0.077 0.125 0.1705...   % Treg parameters
                 0.0155 40 0.823 0.703 0.057 0.561 0.109 0.119 0.190... % Teff parameters
                 9.010 35 0.123 0.452 0.101 0.084 0.147 0.05...   % M parameters
                 10.091 15 0.079 0.0005...      % EC parameters
                 8.85 90 0.362 0.108 0.136 0.001]; % F parameters % These values may be updated during optimization  
...
inputs.exps.exp_data{1}=[                              
		11.15 7.24 49.66 8.15 4.91 20.89
        %18.39 6.84 16.77 15.87 2.71 39.42 
        7.42 0.89 21.09 15.41 1.47 38.72 
		];
...
inputs.PEsol.global_theta_guess=[0.15 0.185 0.05 0.1705 0.0155 0.190 9.010 0.05 9.091 0.005 8.85 0.001];
