% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT075.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N75_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN75_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[2.50E+00 90 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 6.42E+00...   % CC parameters
                 1.76E+00 15 0.699 0.749 0.103 0.729 0.085 0.059 0.077 5.23E+00...   % Treg parameters
                 9.68E+00 40 0.823 0.703 0.057 0.561 0.109 1.36E-01... % Teff parameters
                 4.34E-01 35 0.123 0.452 0.101 0.084 7.64E+00...   % M parameters
                 8.57E+00 15 8.82E+00...      % EC parameters
                 9.55E+00 90 0.362 0.108 3.92E-02]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[11.15 7.24 49.66 8.15 4.91 20.89];  %Initial conditions for each experiment          
