% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT158.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N158_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN158_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[1.03E-02 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 9.94E+00...   % CC parameters
                 2.70E+00 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 4.53E+00...   % Treg parameters
                 5.32E+00 40 0.823 0.703 0.057 0.561 0.109 3.12E+00... % Teff parameters
                 6.47E-03 25 0.823 0.652 0.101 0.084 9.38E+00...   % M parameters
                 3.43E+00 10 3.98E+00...      % EC parameters
                 2.55E+00 65 0.362 0.108 3.27E-02]; % F parameters % These values may be updated during optimization  
