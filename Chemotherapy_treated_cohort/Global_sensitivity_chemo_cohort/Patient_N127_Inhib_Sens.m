% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT127.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N127_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN127_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[4.8227e+00 55 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 6.1835e+00...   % CC parameters
                 5.1909e+00 20 0.699 0.749 0.103 0.129 0.085 0.059 0.077 8.3475e+00...   % Treg parameters
                 8.3475e+00 50 0.823 0.703 0.057 0.561 0.109 7.2076e+00... % Teff parameters
                 8.4271e+00 50 0.823 0.652 0.101 0.084 2.0119e-02...   % M parameters
                 5.2295e-02 20  8.3475e+00...      % EC parameters
                 2.0953e-01 30 0.362 0.108 5.5390e+00]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[17.36 10.26 27.96 17.81 10.03 16.54];  %Initial conditions for each experiment          
