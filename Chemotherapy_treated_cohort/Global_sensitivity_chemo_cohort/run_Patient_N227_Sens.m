...
Patient_N227_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N227_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N227 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
