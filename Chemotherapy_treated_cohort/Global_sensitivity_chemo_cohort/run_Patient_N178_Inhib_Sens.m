...
Patient_N178_Inhib_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N178_RD_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N178 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
