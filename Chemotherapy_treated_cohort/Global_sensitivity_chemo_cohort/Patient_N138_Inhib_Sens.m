% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT138.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N138_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN138_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[1.00E-01 60 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 2.13E+00...   % CC parameters
                 5.90E+00 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 4.17E+00...   % Treg parameters
                 9.68E+00 25 0.823 0.703 0.057 0.561 0.109 8.59E-01... % Teff parameters
                 1.14E+00 25 0.823 0.652 0.101 0.084 6.75E+00...   % M parameters
                 5.40E+00 25 9.98E+00...      % EC parameters
                 8.26E+00 65 0.362 0.108 1.81E-01]; % F parameters % These values may be updated during optimization  
