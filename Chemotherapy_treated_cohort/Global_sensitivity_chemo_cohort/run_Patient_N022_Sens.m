...
Patient_N022_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_NT022_PCRGrowth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N022 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
