...
output_filename = 'Patient_N196_RD_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N196 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
