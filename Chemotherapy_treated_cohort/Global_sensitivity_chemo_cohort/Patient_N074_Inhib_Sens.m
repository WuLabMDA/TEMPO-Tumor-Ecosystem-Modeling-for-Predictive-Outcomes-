% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT074.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_rd3_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_prd3_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[6.3083e-01 90 0.114 0.132 0.067 0.12 0.505 0.12 0.207 0.136 0.107 0.128 0.124 9.0811e+00...   % CC parameters
                 2.2159e+00 15 0.699 0.749 0.103 0.729 0.085 0.059 0.077 9.6141e+00...   % Treg parameters
                 9.1704e+00 40 0.823 0.703 0.057 0.561 0.109 4.1642e-01... % Teff parameters
                 1.3018e+00 35 0.123 0.452 0.101 0.084 9.6141e+00...   % M parameters
                 7.6527e+00 15 4.5225e+00...      % EC parameters
                 7.5267e+00 90 0.362 0.108 4.2450e-01]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[59.15 2.21 4.31 1.39 3.60 29.27];  %Initial conditions for each experiment          
