% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT129.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N129_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN129_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[5.20E-01 75 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 9.67E+00...   % CC parameters
                 1.78E+00 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 6.18E+00...   % Treg parameters
                 9.96E+00 30 0.823 0.703 0.057 0.561 0.109 1.57E-01... % Teff parameters
                 2.64E+00 30 0.823 0.652 0.101 0.084 8.17E+00...   % M parameters
                 6.48E+00 10 3.85E+00...      % EC parameters
                 8.01E+00 65 0.362 0.108 1.40E-01]; % F parameters % These values may be updated during optimization  

% 0.130; 0.108; 0.119; 0.138; 0.109; 0.123
%==================================
