% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT069.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_rd2_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_prd2_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[3.1069e+00 65 0.114 0.132 0.056 0.123 0.575 0.129 0.186 0.128 0.135 0.131 0.123 5.7288e+00...   % CC parameters
                 1.2440e+00 35 0.464 0.39 0.109 0.104 0.082 0.407 0.085 2.0763e+00...   % Treg parameters
                 8.6472e+00 65 0.125 0.094 0.213 0.4100 0.106 4.7497e-01... % Teff parameters
                 3.1138e+00 30 0.123 0.452 0.101 0.084 7.3623e+00...   % M parameters
                 2.0846e+00 25 6.3671e+00...      % EC parameters
                 9.2577e+00 65 0.362 0.108 2.5833e-01]; % F parameters % These values may be updated during optimization  
...
for iexp = 1:inputs.exps.n_exp
 ...
 inputs.exps.u_max{1}=[0.105; 0.177; 0.111; 0.147;0.0104; 0.136];  % inputs.exps.u_min{1}=0;inputs.exps.u_max{1}=1;        %Minimum and maximum value for the input
