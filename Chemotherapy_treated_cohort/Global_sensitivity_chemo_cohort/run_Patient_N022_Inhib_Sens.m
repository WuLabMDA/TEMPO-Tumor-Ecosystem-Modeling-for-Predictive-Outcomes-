...
Patient_N022_Inhib_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_NT022_PCR_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N022 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
