% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT178.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N178_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN178_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[8.9450e+00 15 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 4.8781e+00...   % CC parameters
                 9.2033e+00 20 0.699 0.749 0.103 0.129 0.085 0.059 0.077 7.2268e+00...   % Treg parameters
                 9.5128e+00 75 0.823 0.703 0.057 0.561 0.109 2.1400e-01... % Teff parameters
                 4.8729e-01 30 0.823 0.652 0.101 0.084 9.7559e+00...   % M parameters
                 4.5260e+00 10 1.0308e+00...      % EC parameters
                 9.9269e+00 30 0.362 0.108 2.3435e+00]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[7.42 9.99 58.68 9.94 2.34 11.62];  %Initial conditions for each experiment          
