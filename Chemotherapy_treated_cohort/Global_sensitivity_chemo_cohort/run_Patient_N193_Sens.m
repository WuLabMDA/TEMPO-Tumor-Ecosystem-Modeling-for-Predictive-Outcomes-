...
Patient_N193_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N193_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N193 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
