% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT123.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N123_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN123_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[9.68E-01 80 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 7.88E+00...   % CC parameters
                 7.30E+00 10 0.699 0.749 0.103 0.129 0.085 0.059 0.077 6.96E+00...   % Treg parameters
                 8.28E+00 30 0.823 0.703 0.057 0.561 0.109 4.04E+00... % Teff parameters
                 2.55E-01 10 0.823 0.652 0.101 0.084 9.59E+00...   % M parameters
                 3.98E+00 10 4.61E+00...      % EC parameters
                 3.32E+00 60 0.362 0.108 1.53E-02]; % F parameters % These values may be updated during optimization  
