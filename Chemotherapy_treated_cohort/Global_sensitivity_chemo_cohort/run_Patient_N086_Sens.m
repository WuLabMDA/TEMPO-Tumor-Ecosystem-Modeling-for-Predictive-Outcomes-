...
Patient_N086_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N086_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N086 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
