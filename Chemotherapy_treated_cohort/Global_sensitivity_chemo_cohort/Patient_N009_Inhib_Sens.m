% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT009.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_1_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_p1_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[4.2794e-01 75 0.18 0.22 0.082 0.145 0.52 0.156 0.245 0.148 0.095 0.138 0.142 6.9393e+00...   % CC parameters
                 5.1748e-01 50 0.40 0.85 0.018 0.11 0.095 0.15 0.25 7.6544e+00...   % Treg parameters
                 9.9305e+00 50 0.98 0.92 0.98 0.0905 0.0108 5.4011e+00... % Teff parameters
                 4.1032e-01 50 0.65 0.95 0.11 0.13 8.1283e+00...   % M parameters
                 2.6456e+0 50 2.6447e+00...      % EC parameters
                 4.1684e+00 100 3.6 0.1005 1.0517e-01]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp}=[73.50 2.78 6.31 6.99 5.49 10.94];  %Initial conditions for each experiment          
 inputs.exps.t_f{iexp}= 4;  %Experiments duration
 end
...
% OBSEVABLES DEFINITION  
 ...
 % inputs.exps.n_pulses{iexp}=1;                            %Number of pulses |-|_|-|_|-|_|-|_|-|_    
 % % inputs.exps.u_min{1}=0;inputs.exps.u_max{1}=1;        %Minimum and maximum value for the input
 % inputs.exps.t_con{iexp}=[0 :2 :4];                    %Times of switching: Initial time, Intermediate times, Final time
 end 
...
for iexp = 1:inputs.exps.n_exp
 ...
 inputs.exps.u_max{1}=[0.155; 0.11; 0.09035; 0.155; 0.155; 0.1075];
 % inputs.exps.u_min{1}=0;inputs.exps.u_max{1}=1;        %Minimum and maximum value for the input
...
inputs.PESol.global_theta_guess= rand(1,5).*inputs.model.par([14 24 32 30 47]);  % Value of the parameters for which the analysis will be performed    
