...
Patient_N153_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N153_PCR_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N153 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
