...
Patient_N062_Inhib_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N062_RD_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N062 Inhibition Rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
