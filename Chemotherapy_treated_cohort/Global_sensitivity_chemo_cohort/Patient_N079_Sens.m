...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N79';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN79';                      % To identify figures and reports for a given problem   
