% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT086.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_N86_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_pN86_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[3.96E-01 10 0.114 0.132 0.067 0.12 0.205 0.12 0.107 0.106 0.107 0.128 0.124 9.99E+00...   % CC parameters
                 8.33E+00 15 0.699 0.749 0.103 0.129 0.085 0.059 0.077 6.83E+00...   % Treg parameters
                 7.24E+00 60 0.823 0.703 0.057 0.561 0.109 2.18E+00... % Teff parameters
                 3.21E+00 50 0.823 0.652 0.101 0.084 9.03E+00...   % M parameters
                 3.64E+00 10 2.49E+00...      % EC parameters
                 4.40E+00 90 0.362 0.108 1.13E-01]; % F parameters % These values may be updated during optimization  
