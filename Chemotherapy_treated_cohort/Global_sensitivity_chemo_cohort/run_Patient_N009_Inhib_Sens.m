...
Patient_N009_Inhib_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
parameter_names = {'mu\_cc', 'mu\_treg','mu\_teff','mu\_m', 'mu\_f' };
...
output_filename = 'Patient_NT009_PCR_Inhibition_Rate_Sensitivity_Matrix.csv';
...
title('Patient N009 Inhibition rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
