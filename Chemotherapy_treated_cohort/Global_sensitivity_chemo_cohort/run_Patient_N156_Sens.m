...
Patient_N156_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_N156_RD_Growth_Rate_Sensitivity_Matrix.csv';
...
title('Patient N156 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
