% $Header: svn://.../trunk/AMIGO2R2016/IMC_BC_Analysis/Sensitivity_Analysis/Chemotherapy/Patient_NT040.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inputs.pathd.results_folder='sens_imc_bc_chemotherapy_rd1_inhib';         % Folder to keep results (in Results) for a given problem          
inputs.pathd.short_name='sens_imc_chemo_prd1_inhib';                      % To identify figures and reports for a given problem   
...
inputs.model.par=[5.6144e+00 65 0.11 0.99 0.07 0.121 0.635 0.126 0.201 0.127 0.08 0.131 0.122 7.5123e+00...   % CC parameters
                 2.7167e+00 15 0.462 0.161 0.103 0.101 0.08 0.476 0.140 4.5800e+00...   % Treg parameters
                 3.3378e+00 35 0.123 0.11 0.132 0.181 0.109 4.4477e+00... % Teff parameters
                 9.5918e+00 30 0.151 0.595 0.08 0.065 3.1308e-01...   % M parameters
                 9.9381e+00 20 5.0034e-03...      % EC parameters
                 3.3581e+00 35 0.301 0.255 8.2765e+00]; % F parameters % These values may be updated during optimization  
...
%==================================
 ...
 inputs.exps.exp_y0{iexp} = [50.39 3.69 21.45 4.16 5.72 14.59];  %Initial conditions for each experiment          
...
for iexp = 1:inputs.exps.n_exp
 ...
 inputs.exps.u_max{1}=[0.123; 0.121; 0.201; 0.107;0.111; 0.124];
...
%In_CC In_Teff Gr_Teff Gr_M In_Treg Gr_Treg In_M In_F Gr_CC Gr_EC
 %==================================
 % SIMULATION
