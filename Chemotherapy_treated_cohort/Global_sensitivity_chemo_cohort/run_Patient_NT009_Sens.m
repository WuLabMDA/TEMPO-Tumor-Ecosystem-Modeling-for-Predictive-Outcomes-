...
Patient_NT009_Sens % Calls the script with the inputs: 
                           % Model
                           % Experimental scheme 
...
output_filename = 'Patient_NT009_PCR_Sensitivity_Matrix.csv';
...
title('Patient N009 Growth rate Sensitivity Analysis Results', 'FontSize', 14, 'FontWeight', 'bold');
